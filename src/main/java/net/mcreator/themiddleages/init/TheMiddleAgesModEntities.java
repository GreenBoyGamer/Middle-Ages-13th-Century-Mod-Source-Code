...
public class TheMiddleAgesModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<DarkSoldierEntity>> DARK_SOLDIER = register("dark_soldier",
			EntityType.Builder.<DarkSoldierEntity>of(DarkSoldierEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
					...
					.sized(0.6f, 1.8f));
	public static final DeferredHolder<EntityType<?>, EntityType<MadievalHorseEntity>> MADIEVAL_HORSE = register("madieval_horse",
			EntityType.Builder.<MadievalHorseEntity>of(MadievalHorseEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
	...
	public static final DeferredHolder<EntityType<?>, EntityType<ArcherEntity>> ARCHER = register("archer",
			EntityType.Builder.<ArcherEntity>of(ArcherEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)

					.sized(0.6f, 1.8f));
	public static final DeferredHolder<EntityType<?>, EntityType<EnemyArcherEntity>> ENEMY_ARCHER = register("enemy_archer",
			EntityType.Builder.<EnemyArcherEntity>of(EnemyArcherEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
	...
	public static final DeferredHolder<EntityType<?>, EntityType<PassengerCartRidingEntity>> PASSENGER_CART_RIDING = register("passenger_cart_riding",
			EntityType.Builder.<PassengerCartRidingEntity>of(PassengerCartRidingEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(MADIEVAL_HORSE.get(), MadievalHorseEntity.createAttributes().build());
