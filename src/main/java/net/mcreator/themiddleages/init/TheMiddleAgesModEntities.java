...
public class TheMiddleAgesModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<WandererEntity>> WANDERER = register("wanderer",
			EntityType.Builder.<WandererEntity>of(WandererEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)

					.notInPeaceful().sized(0.6f, 1.95f));
	public static final DeferredHolder<EntityType<?>, EntityType<Civilian5Entity>> CIVILIAN_5 = register("civilian_5",
			EntityType.Builder.<Civilian5Entity>of(Civilian5Entity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)

					.notInPeaceful().sized(0.6f, 1.8f));
	public static final DeferredHolder<EntityType<?>, EntityType<Civilian4Entity>> CIVILIAN_4 = register("civilian_4",
			EntityType.Builder.<Civilian4Entity>of(Civilian4Entity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)

					.notInPeaceful().sized(0.6f, 1.8f));
	public static final DeferredHolder<EntityType<?>, EntityType<DarkkingEntity>> DARKKING = register("darkking",
			EntityType.Builder.<DarkkingEntity>of(DarkkingEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)

					.notInPeaceful().sized(0.6f, 1.8f));
	public static final DeferredHolder<EntityType<?>, EntityType<GhostOfCruelKingEntity>> GHOST_OF_CRUEL_KING = register("ghost_of_cruel_king",
			EntityType.Builder.<GhostOfCruelKingEntity>of(GhostOfCruelKingEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).fireImmune()

					.notInPeaceful().sized(1f, 1f));
	public static final DeferredHolder<EntityType<?>, EntityType<BountyProviderEntity>> BOUNTY_PROVIDER = register("bounty_provider",
			EntityType.Builder.<BountyProviderEntity>of(BountyProviderEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).fireImmune()
	...
	public static void registerCapabilities(RegisterCapabilitiesEvent event) {
		event.registerEntity(Capabilities.Item.ENTITY, CIVILIAN_5.get(), (living, context) -> living.getCombinedInventory());
		event.registerEntity(Capabilities.Item.ENTITY, CIVILIAN_4.get(), (living, context) -> living.getCombinedInventory());
		event.registerEntity(Capabilities.Item.ENTITY, CIVILIAN_3.get(), (living, context) -> living.getCombinedInventory());
		event.registerEntity(Capabilities.Item.ENTITY, BUYER.get(), (living, context) -> living.getCombinedInventory());
		event.registerEntity(Capabilities.Item.ENTITY, WANDERER.get(), (living, context) -> living.getCombinedInventory());
		event.registerEntity(Capabilities.Item.ENTITY, BREAD_SELLER.get(), (living, context) -> living.getCombinedInventory());
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		...
		Civilian5Entity.init(event);
		Civilian4Entity.init(event);
		DarkkingEntity.init(event);
		GhostOfCruelKingEntity.init(event);
		BountyProviderEntity.init(event);
	}
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(CIVILIAN_5.get(), Civilian5Entity.createAttributes().build());
		event.put(CIVILIAN_4.get(), Civilian4Entity.createAttributes().build());
		event.put(DARKKING.get(), DarkkingEntity.createAttributes().build());
		event.put(GHOST_OF_CRUEL_KING.get(), GhostOfCruelKingEntity.createAttributes().build());
		event.put(BOUNTY_PROVIDER.get(), BountyProviderEntity.createAttributes().build());
	}
}