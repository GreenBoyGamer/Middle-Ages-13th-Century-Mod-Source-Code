...
import net.mcreator.themiddleages.item.*;
...
public class TheMiddleAgesModItems {
	...
	public static final DeferredItem<Item> SOLDIER_ARMOR_HELMET;
	public static final DeferredItem<Item> SOLDIER_ARMOR_CHESTPLATE;
	public static final DeferredItem<Item> SOLDIER_ARMOR_LEGGINGS;
	public static final DeferredItem<Item> SOLDIER_ARMOR_BOOTS;
	public static final DeferredItem<Item> CROWN_HELMET;
	public static final DeferredItem<Item> CROWN_BLOCK;
	public static final DeferredItem<Item> CIVILIAN_5_SPAWN_EGG;
	public static final DeferredItem<Item> CIVILIAN_4_SPAWN_EGG;
	public static final DeferredItem<Item> LEATHER_CLOTHS_CHESTPLATE;
	public static final DeferredItem<Item> LEATHER_CLOTHS_LEGGINGS;
	public static final DeferredItem<Item> LEATHER_CLOTHS_BOOTS;
	public static final DeferredItem<Item> DARKKING_SPAWN_EGG;
	public static final DeferredItem<Item> WATER_MILL_WATER_PUMP;
	public static final DeferredItem<Item> WATER_MILL_LOG_CUTTER;
	public static final DeferredItem<Item> WHEEL;
	public static final DeferredItem<Item> GHOST_OF_CRUEL_KING_SPAWN_EGG;
	public static final DeferredItem<Item> BOUNTY_PROVIDER_SPAWN_EGG;
	public static final DeferredItem<Item> GHOST_SUMMONER;
	public static final DeferredItem<Item> MEDIEVAL_IRON_SWORD;
	public static final DeferredItem<Item> HISTORY;
	static {
		...
		SOLDIER_ARMOR_HELMET = register("soldier_armor_helmet", SoldierArmorItem.Helmet::new);
		SOLDIER_ARMOR_CHESTPLATE = register("soldier_armor_chestplate", SoldierArmorItem.Chestplate::new);
		SOLDIER_ARMOR_LEGGINGS = register("soldier_armor_leggings", SoldierArmorItem.Leggings::new);
		SOLDIER_ARMOR_BOOTS = register("soldier_armor_boots", SoldierArmorItem.Boots::new);
		CROWN_HELMET = register("crown_helmet", CrownItem.Helmet::new);
		CROWN_BLOCK = block(TheMiddleAgesModBlocks.CROWN_BLOCK);
		CIVILIAN_5_SPAWN_EGG = register("civilian_5_spawn_egg", properties -> new SpawnEggItem(properties.spawnEgg(TheMiddleAgesModEntities.CIVILIAN_5.get())));
		CIVILIAN_4_SPAWN_EGG = register("civilian_4_spawn_egg", properties -> new SpawnEggItem(properties.spawnEgg(TheMiddleAgesModEntities.CIVILIAN_4.get())));
		LEATHER_CLOTHS_CHESTPLATE = register("leather_cloths_chestplate", LeatherClothsItem.Chestplate::new);
		LEATHER_CLOTHS_LEGGINGS = register("leather_cloths_leggings", LeatherClothsItem.Leggings::new);
		LEATHER_CLOTHS_BOOTS = register("leather_cloths_boots", LeatherClothsItem.Boots::new);
		DARKKING_SPAWN_EGG = register("darkking_spawn_egg", properties -> new SpawnEggItem(properties.spawnEgg(TheMiddleAgesModEntities.DARKKING.get())));
		WATER_MILL_WATER_PUMP = block(TheMiddleAgesModBlocks.WATER_MILL_WATER_PUMP);
		WATER_MILL_LOG_CUTTER = block(TheMiddleAgesModBlocks.WATER_MILL_LOG_CUTTER);
		WHEEL = register("wheel", WheelItem::new);
		GHOST_OF_CRUEL_KING_SPAWN_EGG = register("ghost_of_cruel_king_spawn_egg", properties -> new SpawnEggItem(properties.spawnEgg(TheMiddleAgesModEntities.GHOST_OF_CRUEL_KING.get())));
		BOUNTY_PROVIDER_SPAWN_EGG = register("bounty_provider_spawn_egg", properties -> new SpawnEggItem(properties.spawnEgg(TheMiddleAgesModEntities.BOUNTY_PROVIDER.get())));
		GHOST_SUMMONER = register("ghost_summoner", GhostSummonerItem::new);
		MEDIEVAL_IRON_SWORD = register("medieval_iron_sword", MedievalIronSwordItem::new);
		HISTORY = register("history", HistoryItem::new);
	}
