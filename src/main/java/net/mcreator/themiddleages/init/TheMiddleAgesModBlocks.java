...
public class TheMiddleAgesModBlocks {
	...
	public static final DeferredBlock<Block> CROWN_BLOCK;
	public static final DeferredBlock<Block> WATER_MILL_WATER_PUMP;
	public static final DeferredBlock<Block> WATER_MILL_LOG_CUTTER;
	static {
		...
		CROWN_BLOCK = register("crown_block", CrownBlockBlock::new);
		WATER_MILL_WATER_PUMP = register("water_mill_water_pump", WaterMillWaterPumpBlock::new);
		WATER_MILL_LOG_CUTTER = register("water_mill_log_cutter", WaterMillLogCutterBlock::new);
	}
