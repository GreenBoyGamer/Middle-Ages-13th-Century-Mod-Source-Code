...
@EventBusSubscriber
public class MadievalJungleTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<MadievalJungleTrunkDecorator> CODEC = MapCodec.unit(MadievalJungleTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("the_middle_ages:madieval_jungle_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
