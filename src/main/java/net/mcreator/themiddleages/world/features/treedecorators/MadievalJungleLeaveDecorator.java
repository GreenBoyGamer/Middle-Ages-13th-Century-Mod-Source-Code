...
@EventBusSubscriber
public class MadievalJungleLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<MadievalJungleLeaveDecorator> CODEC = MapCodec.unit(MadievalJungleLeaveDecorator::new);
