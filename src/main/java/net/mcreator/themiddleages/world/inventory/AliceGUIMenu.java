...
public class AliceGUIMenu extends AbstractContainerMenu implements TheMiddleAgesModMenus.MenuAccessor {
	...
	public AliceGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheMiddleAgesModMenus.ALICE_GUI.get(), id);
