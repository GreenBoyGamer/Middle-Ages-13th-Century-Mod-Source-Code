...
public class HistoryGUIMenu extends AbstractContainerMenu implements TheMiddleAgesModMenus.MenuAccessor {
	...
	public HistoryGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheMiddleAgesModMenus.HISTORY_GUI.get(), id);
