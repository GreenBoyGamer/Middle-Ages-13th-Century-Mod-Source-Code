...
public class WandererGUIMenu extends AbstractContainerMenu implements TheMiddleAgesModMenus.MenuAccessor {
	...
	public WandererGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheMiddleAgesModMenus.WANDERER_GUI.get(), id);
