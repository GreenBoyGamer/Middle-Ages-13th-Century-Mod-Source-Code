...
public class KnightsAndSoldiersMenu extends AbstractContainerMenu implements TheMiddleAgesModMenus.MenuAccessor {
	...
	public KnightsAndSoldiersMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheMiddleAgesModMenus.KNIGHTS_AND_SOLDIERS.get(), id);
