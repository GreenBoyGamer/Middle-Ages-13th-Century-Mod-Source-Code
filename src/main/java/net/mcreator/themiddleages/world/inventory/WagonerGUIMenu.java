...
public class WagonerGUIMenu extends AbstractContainerMenu implements TheMiddleAgesModMenus.MenuAccessor {
	...
	public WagonerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheMiddleAgesModMenus.WAGONER_GUI.get(), id);
