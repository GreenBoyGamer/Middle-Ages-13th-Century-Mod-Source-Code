...
public class HistoryGUI2Menu extends AbstractContainerMenu implements TheMiddleAgesModMenus.MenuAccessor {
	...
	public HistoryGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheMiddleAgesModMenus.HISTORY_GUI_2.get(), id);
