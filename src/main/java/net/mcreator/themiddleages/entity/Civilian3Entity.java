...
public class Civilian3Entity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_wasDoing = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_stillDoing = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_Eat = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_giveThanks = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_moneyGive = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_farming = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_buy = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_hungry = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_TimeToDie = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_GraveCarry = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_gettingrobbed = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_notRobbingAgain = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_meet = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_dontDo = SynchedEntityData.defineId(Civilian3Entity.class, EntityDataSerializers.INT);
	...
	public Civilian3Entity(EntityType<Civilian3Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Civilian3DiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata);
		Civilian3InitialSpawnProcedure.execute(world, this);
		return retval;
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Lisa [PEASANT]");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(Civilian3Entity.this.getId());
					return new Civilian3GUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			...
			this.animationState2.animateWhen(Civilian3RunningPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState3.animateWhen(Civilian3SleepPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState4.animateWhen(Civilian3wakePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState5.animateWhen(Civilian3buyPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState6.animateWhen(Civilian3eatPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState7.animateWhen(Civilian3diePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState8.animateWhen(Civilian3meetPlaybackConditionProcedure.execute(this), this.tickCount);
		}
	}
	...
	public void baseTick() {
		super.baseTick();
		Civilian3OnEntityUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
