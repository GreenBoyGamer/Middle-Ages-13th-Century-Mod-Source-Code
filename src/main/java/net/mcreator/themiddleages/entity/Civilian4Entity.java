...
import net.mcreator.themiddleages.world.inventory.Civilian4GUIMenu;
...
public class Civilian4Entity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_wasDoing = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_stillDoing = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_Eat = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_giveThanks = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_moneyGive = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_buy = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_hungry = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_TimeToDie = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_GraveCarry = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_gettingrobbed = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_notRobbingAgain = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_meet = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_dontDo = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_DoingJob = SynchedEntityData.defineId(Civilian4Entity.class, EntityDataSerializers.INT);
	...
	public Civilian4Entity(EntityType<Civilian4Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Civilian4DiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata);
		Civilian4initialSpawnProcedure.execute(world, this);
		return retval;
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Alice [Weaver]");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(Civilian4Entity.this.getId());
					return new Civilian4GUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(Civilian4idlePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState2.animateWhen(Civilian4SleepPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState3.animateWhen(Civilian4WakeupPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState4.animateWhen(Civilian4buyPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState5.animateWhen(Civilian4EatPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState6.animateWhen(Civilian4diePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState7.animateWhen(Civilian4diePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState8.animateWhen(Civilian4SmithingPlaybackConditionProcedure.execute(this), this.tickCount);
		}
	}
	...
	public void baseTick() {
		super.baseTick();
		Civilian4OnTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
