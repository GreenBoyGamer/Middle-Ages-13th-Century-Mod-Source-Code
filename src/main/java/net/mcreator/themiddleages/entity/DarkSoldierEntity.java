...
public class DarkSoldierEntity extends Monster {
	...
	public static final EntityDataAccessor<Integer> DATA_Peasents_Carry_Amount = SynchedEntityData.defineId(DarkSoldierEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Peasents_Amount2 = SynchedEntityData.defineId(DarkSoldierEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Peasents_Amount3 = SynchedEntityData.defineId(DarkSoldierEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Peasents_Amount4 = SynchedEntityData.defineId(DarkSoldierEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Peasents_Amount5 = SynchedEntityData.defineId(DarkSoldierEntity.class, EntityDataSerializers.INT);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(DATA_Peasents_Carry_Amount, 0);
		builder.define(DATA_Peasents_Amount2, 0);
		builder.define(DATA_Peasents_Amount3, 0);
		builder.define(DATA_Peasents_Amount4, 0);
		builder.define(DATA_Peasents_Amount5, 0);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, ArcherEntity.class, false, false));
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, Player.class, false, false));
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, KnightRidingHorseEntity.class, false, false));
		this.goalSelector.addGoal(11, new AvoidEntityGoal<>(this, Player.class, (float) 12, 1.2, 1.2));
		this.goalSelector.addGoal(12, new FollowMobGoal(this, 1, (float) 10, (float) 5));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		DarkSoldierDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.putInt("DataPeasents_Carry_Amount", this.entityData.get(DATA_Peasents_Carry_Amount));
		valueOutput.putInt("DataPeasents_Amount2", this.entityData.get(DATA_Peasents_Amount2));
		valueOutput.putInt("DataPeasents_Amount3", this.entityData.get(DATA_Peasents_Amount3));
		valueOutput.putInt("DataPeasents_Amount4", this.entityData.get(DATA_Peasents_Amount4));
		valueOutput.putInt("DataPeasents_Amount5", this.entityData.get(DATA_Peasents_Amount5));
	}
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.entityData.set(DATA_Peasents_Carry_Amount, valueInput.getIntOr("DataPeasents_Carry_Amount", 0));
		this.entityData.set(DATA_Peasents_Amount2, valueInput.getIntOr("DataPeasents_Amount2", 0));
		this.entityData.set(DATA_Peasents_Amount3, valueInput.getIntOr("DataPeasents_Amount3", 0));
		this.entityData.set(DATA_Peasents_Amount4, valueInput.getIntOr("DataPeasents_Amount4", 0));
		this.entityData.set(DATA_Peasents_Amount5, valueInput.getIntOr("DataPeasents_Amount5", 0));
	}
