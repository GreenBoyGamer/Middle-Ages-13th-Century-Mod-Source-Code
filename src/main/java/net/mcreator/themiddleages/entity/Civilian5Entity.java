...
import net.mcreator.themiddleages.world.inventory.Civilian5GUIMenu;
...
public class Civilian5Entity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_wasDoing = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_stillDoing = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_Eat = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_giveThanks = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_moneyGive = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_buy = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_hungry = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_TimeToDie = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_GraveCarry = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_gettingrobbed = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_notRobbingAgain = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_meet = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_dontDo = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_DoingJob = SynchedEntityData.defineId(Civilian5Entity.class, EntityDataSerializers.INT);
	...
	public Civilian5Entity(EntityType<Civilian5Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(DATA_DoingJob, 0);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		Civilian5DiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata);
		Civilian5InitialSpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.putInt("DataDoingJob", this.entityData.get(DATA_DoingJob));
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.entityData.set(DATA_DoingJob, valueInput.getIntOr("DataDoingJob", 0));
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("John Smith [BLACK SMITH]");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(Civilian5Entity.this.getId());
					return new Civilian5GUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(Civilian5idlePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState2.animateWhen(Civilian5SleepPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState3.animateWhen(Civilian5WakeupPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState4.animateWhen(Civilian5buyPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState5.animateWhen(Civilian5EatPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState6.animateWhen(Civilian5diePlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState7.animateWhen(Civilian5MeetPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState8.animateWhen(Civilian5SmithingPlaybackConditionProcedure.execute(this), this.tickCount);
		}
	}
	...
	public void baseTick() {
		super.baseTick();
		Civilian5OnTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
