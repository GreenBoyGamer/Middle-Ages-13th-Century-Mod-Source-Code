...
public class KnightEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_actionstate = SynchedEntityData.defineId(KnightEntity.class, EntityDataSerializers.INT);
	...
	public void die(DamageSource source) {
		super.die(source);
		KnightEntityDiesProcedure.execute(this);
	}
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(KnightnotPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState3.animateWhen(KnightAttackAniamtion1PlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState4.animateWhen(KnightAttack2PlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState5.animateWhen(KnightAttack3AniamtionConditionProcedure.execute(this), this.tickCount);
			this.animationState6.animateWhen(KnightDeadPlaybackConditionProcedure.execute(this), this.tickCount);
		}
	}
	...
	public void baseTick() {
		super.baseTick();
		KnightOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
