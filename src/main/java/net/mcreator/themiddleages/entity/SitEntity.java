...
import net.mcreator.themiddleages.procedures.SitOnEntityTickUpdateProcedure;

public class SitEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_mount = SynchedEntityData.defineId(SitEntity.class, EntityDataSerializers.INT);
	...
	public void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.putInt("Datamount", this.entityData.get(DATA_mount));
	}

	@Override
	public void readAdditionalSaveData(ValueInput valueInput) {
		super.readAdditionalSaveData(valueInput);
		this.entityData.set(DATA_mount, valueInput.getIntOr("Datamount", 0));
	}

	@Override
	public void baseTick() {
		super.baseTick();
		SitOnEntityTickUpdateProcedure.execute(this);
	}
