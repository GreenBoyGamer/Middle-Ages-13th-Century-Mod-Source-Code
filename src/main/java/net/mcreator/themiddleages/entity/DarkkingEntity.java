...
public class DarkkingEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_actionstate = SynchedEntityData.defineId(DarkkingEntity.class, EntityDataSerializers.INT);
	...
	public DarkkingEntity(EntityType<DarkkingEntity> type, Level world) {
		super(type, world);
		xpReward = 23;
		setNoAi(false);
		setCustomName(Component.literal("Dark Warrior King"));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
			...
			public boolean canUse() {
				double x = DarkkingEntity.this.getX();
				double y = DarkkingEntity.this.getY();
				double z = DarkkingEntity.this.getZ();
				Entity entity = DarkkingEntity.this;
				Level world = DarkkingEntity.this.level();
		...
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, KnightRidingHorseEntity.class, false, false));
	...
	public void die(DamageSource source) {
		super.die(source);
		KingEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(KingnotPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState2.animateWhen(KingAttackAniamtion1PlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState3.animateWhen(KingAttack2PlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState4.animateWhen(KingDeadPlaybackConditionProcedure.execute(this), this.tickCount);
		}
	}
	...
	public void baseTick() {
		super.baseTick();
		KingOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
