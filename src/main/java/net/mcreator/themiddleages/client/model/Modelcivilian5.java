...
public class Modelcivilian5 extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("the_middle_ages", "modelcivilian_5"), "main");
	...
	public Modelcivilian5(ModelPart root) {
		super(root);
		...
		this.hammer = this.LeftArm2.getChild("hammer");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r132 = Head.addOrReplaceChild("Head_r132", CubeListBuilder.create().texOffs(58, 24).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0833F, -2.15F, -3.6469F, -0.1309F, 0.0F, 0.0F));
		PartDefinition eyebrow = Head.addOrReplaceChild("eyebrow",
				CubeListBuilder.create().texOffs(105, 63).addBox(-8.0568F, -27.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63).addBox(-2.3068F, -27.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						...
						.addBox(-5.3068F, -25.0F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63).addBox(-5.3068F, -25.75F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r134 = eyebrow.addOrReplaceChild("Head_r134",
				...
				PartPose.offsetAndRotation(-5.6F, -29.25F, -3.5F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(3, 27).addBox(-1.5F, 5.0F, -2.5F, 3.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						.addBox(-0.5F, 5.0117F, -2.557F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37).addBox(-0.5F, 6.9117F, -2.557F, 1.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						...
						.addBox(-4.6F, 9.0F, -2.6F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(70, 22).addBox(-2.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(2, 67)
						.addBox(3.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67).addBox(1.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(68, 22)
						.addBox(-4.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(66, 1).addBox(-4.05F, 8.5F, -3.4F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
		...
		PartDefinition hammer = LeftArm2.addOrReplaceChild("hammer", CubeListBuilder.create().texOffs(112, 65).addBox(-0.5F, -0.5F, 0.5833F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 65)
				.addBox(-0.5F, -0.5F, -1.4167F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 2).addBox(-0.5F, -0.5F, 2.5833F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(1.1167F, 4.5833F, -3.9F));
		PartDefinition Body_r8 = hammer.addOrReplaceChild("Body_r8", CubeListBuilder.create().texOffs(117, 79).addBox(-1.5F, -1.5F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5117F, 0.6667F, -1.1068F, 1.5708F, 0.0F, 0.0F));
		PartDefinition Body_r9 = hammer.addOrReplaceChild("Body_r9", CubeListBuilder.create().texOffs(116, 78).addBox(-1.5F, -1.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -0.6667F, -1.0755F, 1.5708F, 0.0F, 0.0F));
		PartDefinition Body_r10 = hammer.addOrReplaceChild("Body_r10", CubeListBuilder.create().texOffs(116, 78).addBox(-1.5F, -1.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5078F, 0.0F, -1.0833F, 1.5708F, 0.0F, 0.0F));
