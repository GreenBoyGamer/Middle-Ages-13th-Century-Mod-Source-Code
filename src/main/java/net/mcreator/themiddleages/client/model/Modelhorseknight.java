...
public class Modelhorseknight extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("the_middle_ages", "modelhorseknight"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition whole = root.addOrReplaceChild("whole", CubeListBuilder.create(), PartPose.offset(2.0F, -8.0F, -8.6667F));
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(92, 20).addBox(-0.3976F, -8.0937F, -4.4593F, 1.0F, 3.0F, 8.5F, new CubeDeformation(0.0F)).texOffs(104, 139).addBox(-3.2976F, -7.9937F, 3.8907F, 6.4F, 8.0F, 0.05F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -12.0F, 0.0F));
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(111, 0).addBox(1.0F, -29.0F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(148, 44).addBox(1.0F, -29.0F, 3.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 73)
						.addBox(1.0F, -32.0F, -4.0F, 4.0F, 3.25F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 73).addBox(1.0F, -28.25F, -4.0F, 3.8F, 4.25F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.6476F, 24.0F, 0.0719F, 0.0F, 0.0873F, 0.0F));
		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(107, 33).addBox(2.0F, -29.0F, -4.0F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.6476F, 24.0F, 0.1446F, 0.0F, 0.0873F, 0.0F));
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(148, 41).addBox(1.0F, -29.0F, 3.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(74, 53).addBox(1.0F, -32.0F, -4.0F, 4.0F, 3.25F, 8.0F, new CubeDeformation(0.0F)).texOffs(25, 73)
						.addBox(1.2F, -28.25F, -4.0F, 3.8F, 4.25F, 8.0F, new CubeDeformation(0.0F)).texOffs(111, 10).addBox(4.0F, -29.0F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.3296F, 24.0F, -0.451F, 0.0F, -0.0873F, 0.0F));
		PartDefinition Head_r4 = Head.addOrReplaceChild("Head_r4", CubeListBuilder.create().texOffs(75, 145).addBox(1.0F, -31.0F, -4.0F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.3296F, 24.0F, -0.3963F, 0.0F, -0.0873F, 0.0F));
		PartDefinition Head_r5 = Head.addOrReplaceChild("Head_r5",
				CubeListBuilder.create().texOffs(75, 81).addBox(1.0F, -31.0F, -4.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(50, 85).addBox(1.0F, -34.3333F, -4.0F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r6 = Head.addOrReplaceChild("Head_r6",
				CubeListBuilder.create().texOffs(86, 33).addBox(2.0F, -31.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(73, 93).addBox(2.0F, -34.3333F, -4.0F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.3296F, 27.0333F, -0.5057F, 0.0F, -0.0873F, 0.0F));
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 146).addBox(-4.3151F, -4.2687F, -1.9025F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 73).addBox(-4.3151F, -4.2687F, -2.0025F, 7.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(143, 15).addBox(2.0849F, -4.2687F, -2.0025F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(105, 111).addBox(-4.3151F, -4.2687F, -1.8025F, 7.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(143, 21)
						.addBox(2.0849F, -4.2687F, -1.8025F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(17, 139).addBox(-1.0029F, -6.8573F, -1.94F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0796F, -1.3154F, -0.0975F));
		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(0, 136).addBox(-3.9176F, -4.9061F, -1.8625F, 4.0F, 5.0F, 3.8F, new CubeDeformation(0.0F)).texOffs(134, 78).addBox(-3.9176F, -4.9061F, -1.6625F, 4.0F, 5.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2389F, -4.196F, -0.04F, 0.0F, 0.0F, -0.0436F));
		PartDefinition Body_r2 = Body.addOrReplaceChild("Body_r2", CubeListBuilder.create().texOffs(122, 56).addBox(-0.6357F, -2.3257F, -1.9F, 5.0F, 5.5667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0706F, -0.8597F, 0.1975F, 0.0F, 0.0F, -3.098F));
		PartDefinition Body_r3 = Body.addOrReplaceChild("Body_r3",
				CubeListBuilder.create().texOffs(68, 124).addBox(-0.964F, -4.9113F, -1.863F, 5.0F, 5.0F, 3.8F, new CubeDeformation(0.0F)).texOffs(124, 117).addBox(-0.964F, -4.9113F, -2.0625F, 5.0F, 5.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0389F, -4.196F, 0.16F, 0.0F, 0.0F, 0.0436F));
		PartDefinition Body_r4 = Body.addOrReplaceChild("Body_r4", CubeListBuilder.create().texOffs(68, 134).addBox(-3.8653F, -2.3039F, -1.9F, 4.0F, 5.5667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.2706F, -0.8597F, 0.1975F, 0.0F, 0.0F, 3.098F));
		PartDefinition Body_r5 = Body.addOrReplaceChild("Body_r5", CubeListBuilder.create().texOffs(51, 139).addBox(-1.0F, -1.25F, -2.0F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0029F, -5.6073F, 0.16F, -3.1416F, 0.0F, 3.1416F));
		PartDefinition Body_r6 = Body.addOrReplaceChild("Body_r6", CubeListBuilder.create().texOffs(139, 141).addBox(-1.8839F, -1.8839F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0029F, -5.6073F, 0.16F, -3.1416F, 0.0F, 2.3562F));
		PartDefinition Body_r7 = Body.addOrReplaceChild("Body_r7", CubeListBuilder.create().texOffs(86, 45).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0029F, -6.8573F, 0.06F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r8 = Body.addOrReplaceChild("Body_r8", CubeListBuilder.create().texOffs(23, 86).addBox(-1.1292F, -5.0708F, -1.9F, 5.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, 0.5975F, -0.0872F, 0.0038F, -3.0981F));
		PartDefinition Body_r9 = Body.addOrReplaceChild("Body_r9", CubeListBuilder.create().texOffs(17, 101).addBox(-3.3718F, -5.049F, -1.9005F, 4.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, 0.5975F, -0.0872F, -0.0038F, 3.0981F));
		PartDefinition Body_r10 = Body.addOrReplaceChild("Body_r10", CubeListBuilder.create().texOffs(130, 15).addBox(-3.3718F, -5.049F, -1.9F, 2.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.1961F, 0.7054F, -0.5025F, 0.0872F, -0.0038F, -3.0981F));
		PartDefinition Body_r11 = Body.addOrReplaceChild("Body_r11", CubeListBuilder.create().texOffs(130, 0).addBox(-3.3718F, -5.049F, -1.9F, 2.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, -0.5025F, 0.0872F, 0.0038F, 3.0981F));
		PartDefinition Body_r12 = Body.addOrReplaceChild("Body_r12", CubeListBuilder.create().texOffs(79, 110).addBox(-3.3718F, -3.049F, -1.9F, 4.0F, 8.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, -0.4025F, 0.0872F, 0.0038F, 3.0981F));
		PartDefinition Body_r13 = Body.addOrReplaceChild("Body_r13", CubeListBuilder.create().texOffs(68, 96).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1849F, -3.7687F, -1.6025F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r14 = Body.addOrReplaceChild("Body_r14", CubeListBuilder.create().texOffs(103, 60).addBox(-1.1292F, -3.0708F, -1.9F, 5.0F, 8.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, -0.4025F, 0.0872F, -0.0038F, -3.0981F));
		PartDefinition Body_r15 = Body.addOrReplaceChild("Body_r15", CubeListBuilder.create().texOffs(105, 117).addBox(-0.6357F, -2.3257F, -1.9F, 5.0F, 5.5667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, -0.8597F, 0.0975F, 0.0F, 0.0F, -3.098F));
		PartDefinition Body_r16 = Body.addOrReplaceChild("Body_r16", CubeListBuilder.create().texOffs(131, 42).addBox(-3.8653F, -2.3039F, -1.9F, 4.0F, 5.5667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, -0.8597F, 0.0975F, 0.0F, 0.0F, 3.098F));
		PartDefinition Body_r17 = Body.addOrReplaceChild("Body_r17", CubeListBuilder.create().texOffs(98, 81).addBox(-0.964F, -6.578F, -1.853F, 5.0F, 6.6667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1389F, -4.196F, 0.06F, 0.0F, 0.0F, 0.0436F));
		PartDefinition Body_r18 = Body.addOrReplaceChild("Body_r18", CubeListBuilder.create().texOffs(0, 124).addBox(-3.9176F, -6.5728F, -1.8625F, 4.0F, 6.6667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1389F, -4.196F, 0.06F, 0.0F, 0.0F, -0.0436F));
		PartDefinition RightArm = Waist.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(51, 116).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -10.0F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition RightArm_r1 = RightArm.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(131, 53).addBox(-3.05F, 1.0F, -1.9F, 5.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(128, 114)
				.addBox(-3.05F, 1.0F, -2.1F, 5.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(128, 111).addBox(-2.95F, 1.0F, -2.1003F, 5.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2398F, -1.2602F, 0.0F, 0.0F, 0.0F, 0.2182F));
		PartDefinition RightArm_r2 = RightArm.addOrReplaceChild("RightArm_r2", CubeListBuilder.create().texOffs(141, 134).addBox(-2.95F, 1.0F, -2.1F, 4.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0738F, -2.418F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition Right_Arm2 = RightArm.addOrReplaceChild("Right_Arm2", CubeListBuilder.create().texOffs(127, 67).addBox(-2.035F, 0.0031F, -2.043F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 4.0F, 0.0F));
		PartDefinition RightArm2 = Right_Arm2.addOrReplaceChild("RightArm2",
				CubeListBuilder.create().texOffs(0, 53).addBox(-0.4942F, -1.0847F, -14.8391F, 1.0F, 2.1F, 17.0F, new CubeDeformation(0.0F)).texOffs(34, 136).addBox(-0.5029F, -0.4859F, 2.9161F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.8587F, 4.6406F, -5.9161F));
		PartDefinition RightArm_r3 = RightArm2.addOrReplaceChild("RightArm_r3", CubeListBuilder.create().texOffs(38, 22).addBox(-0.0007F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5029F, 0.0141F, 9.6161F, -0.7854F, 0.0F, 0.0F));
		PartDefinition RightArm_r4 = RightArm2.addOrReplaceChild("RightArm_r4", CubeListBuilder.create().texOffs(73, 85).addBox(0.0F, -1.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5029F, 0.5297F, 2.6161F, -0.0873F, 0.0F, 0.0F));
		PartDefinition RightArm_r5 = RightArm2.addOrReplaceChild("RightArm_r5", CubeListBuilder.create().texOffs(74, 85).addBox(0.0F, -2.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5029F, -0.4859F, 2.6161F, 0.0873F, 0.0F, 0.0F));
		PartDefinition RightArm_r6 = RightArm2.addOrReplaceChild("RightArm_r6", CubeListBuilder.create().texOffs(34, 101).addBox(-0.5F, -1.05F, -0.793F, 1.0F, 1.4164F, 1.543F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0058F, 0.1776F, -14.5717F, 0.829F, 0.0F, 0.0F));
		PartDefinition Left_Arm = Waist.addOrReplaceChild("Left_Arm", CubeListBuilder.create().texOffs(117, 79).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, -10.0F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition LeftArm_r1 = Left_Arm
				.addOrReplaceChild(
						"LeftArm_r1", CubeListBuilder.create().texOffs(85, 140).addBox(-2.414F, 1.4174F, -1.9F, 5.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(73, 178)
								.addBox(-2.414F, 1.4174F, -2.1F, 5.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(134, 88).addBox(-2.314F, 1.4174F, -2.0996F, 5.0F, -2.0F, 4.0F, new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-1.3004F, -1.705F, 0.0133F, -3.1416F, 0.0F, 3.0543F));
		PartDefinition LeftArm_r2 = Left_Arm.addOrReplaceChild("LeftArm_r2", CubeListBuilder.create().texOffs(141, 63).addBox(-2.0122F, 0.5432F, -2.3002F, 4.0F, -2.0F, 4.2F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.3004F, -1.705F, -0.1867F, -3.1416F, 0.0F, -2.8362F));
		PartDefinition Right_Arm4 = Left_Arm.addOrReplaceChild("Right_Arm4", CubeListBuilder.create().texOffs(34, 125).addBox(-2.035F, -0.0031F, -2.043F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 4.0F, 0.0F));
		PartDefinition LeftArm = Right_Arm4.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(122, 138).addBox(-0.5087F, -0.6635F, 17.4878F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(37, 53).addBox(-0.5174F, -1.2623F, -0.2675F, 1.0F, 2.1F, 17.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.4079F, 4.4135F, -20.4878F));
		PartDefinition LeftArm_r3 = LeftArm.addOrReplaceChild("LeftArm_r3", CubeListBuilder.create().texOffs(34, 105).addBox(-0.5F, -1.05F, -0.793F, 1.0F, 1.4164F, 1.543F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.829F, 0.0F, 0.0F));
		PartDefinition LeftArm_r4 = LeftArm.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(37, 19).addBox(0.0006F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5087F, -0.1635F, 24.1878F, -0.7854F, 0.0F, 0.0F));
		PartDefinition LeftArm_r5 = LeftArm.addOrReplaceChild("LeftArm_r5", CubeListBuilder.create().texOffs(73, 89).addBox(0.0F, -1.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5087F, 0.3521F, 17.1878F, -0.0873F, 0.0F, 0.0F));
		PartDefinition LeftArm_r6 = LeftArm.addOrReplaceChild("LeftArm_r6", CubeListBuilder.create().texOffs(49, 86).addBox(0.0F, -2.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5087F, -0.6635F, 17.1878F, 0.0873F, 0.0F, 0.0F));
		PartDefinition RightLeg = whole.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(113, 20).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.9F, -12.6667F, 0.0F, 0.0F, 0.0F, 0.829F));
		PartDefinition Right_Leg2 = RightLeg
				.addOrReplaceChild(
						"Right_Leg2", CubeListBuilder.create().texOffs(17, 116).addBox(-2.0273F, -0.1147F, -2.0273F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(88, 10)
								.addBox(-2.0273F, 4.8345F, -5.0273F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(109, 93).addBox(-2.0404F, 4.5348F, -4.0273F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 5.1667F, 0.0F, 0.6545F, 0.0F, -0.7854F));
		PartDefinition LeftLeg = whole.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(0, 112).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.9F, -12.6667F, 0.0F, 0.0F, 0.0F, -0.829F));
		PartDefinition Left_Leg4 = LeftLeg
				.addOrReplaceChild(
						"Left_Leg4", CubeListBuilder.create().texOffs(34, 113).addBox(-2.0273F, -0.1679F, -2.0273F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(88, 0)
								.addBox(-2.0273F, 4.8321F, -5.0273F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(109, 102).addBox(-2.0142F, 4.5324F, -4.0273F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 5.1667F, 0.0F, 0.6545F, 0.0F, 0.7854F));
		...
		PartDefinition LeadL = leads.addOrReplaceChild("LeadL", CubeListBuilder.create(), PartPose.offset(5.3333F, 0.0F, 0.0F));
		...
		PartDefinition LeadR = leads.addOrReplaceChild("LeadR", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition body_r19 = body2.addOrReplaceChild("body_r19", CubeListBuilder.create().texOffs(90, 177).addBox(-0.5F, -1.0F, -2.5F, -1.0F, 2.0F, -2.0F, new CubeDeformation(0.05F)).texOffs(202, 182)
		...
		PartDefinition body_r20 = body2.addOrReplaceChild("body_r20", CubeListBuilder.create().texOffs(45, 168).addBox(-1.5F, -1.0F, -2.5F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.05F)).texOffs(240, 230)
		...
		PartDefinition body_r24 = body2.addOrReplaceChild("body_r24", CubeListBuilder.create().texOffs(109, 173).addBox(-2.5F, -2.0F, -2.5F, 9.0F, 7.0F, -8.0F, new CubeDeformation(0.05F)),
		...
		PartDefinition tail_r9 = tail.addOrReplaceChild("tail_r9", CubeListBuilder.create().texOffs(243, 137).addBox(-1.5F, -4.8833F, -1.678F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
