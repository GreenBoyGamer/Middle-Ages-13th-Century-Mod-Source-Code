 ...
 * @author Author
 */
public class female_civilian_1Animation {
	...
	public static final AnimationDefinition walking = AnimationDefinition.Builder.withLength(1.0F).looping().addAnimation("Waist", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("mouth", new AnimationChannel(AnimationChannel.Targets.SCALE, new Keyframe(0.0F, KeyframeAnimations.scaleVec(0.4F, 0.1333F, 1.0F), AnimationChannel.Interpolations.CATMULLROM))).build();
