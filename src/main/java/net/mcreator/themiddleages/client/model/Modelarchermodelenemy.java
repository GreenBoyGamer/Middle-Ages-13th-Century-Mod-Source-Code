...
public class Modelarchermodelenemy extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("the_middle_ages", "modelarchermodelenemy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mouth = head.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(14, 118).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.15F, -0.85F, -3.6F));
		PartDefinition event = head.addOrReplaceChild("event",
				CubeListBuilder.create().texOffs(0, 120).addBox(-0.1667F, -0.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120).addBox(-0.1667F, -2.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120)
						.addBox(-0.8333F, -2.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120).addBox(-0.8333F, -0.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120)
						.addBox(-0.8333F, -4.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120).addBox(-0.1667F, -4.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120)
						.addBox(-0.8333F, 2.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 120).addBox(-0.1667F, 2.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition down_side = right_arm.addOrReplaceChild("down_side", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.1038F, 6.0279F, -0.1688F, -0.2296F, -0.6718F, -0.3395F));
		PartDefinition right_arm2 = down_side.addOrReplaceChild("right_arm2", CubeListBuilder.create().texOffs(80, 70).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.25F, 0.0F));
		PartDefinition bow = down_side.addOrReplaceChild("bow",
				CubeListBuilder.create().texOffs(29, 21).addBox(-0.4665F, 1.6928F, -0.6863F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(30, 20).addBox(-0.4665F, 1.6928F, -3.127F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.8003F, 7.8649F, -0.6495F));
		PartDefinition bow_r1 = bow.addOrReplaceChild("bow_r1", CubeListBuilder.create().texOffs(28, 19).addBox(-0.4995F, -0.0397F, -6.0274F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.033F, 2.6972F, 2.2942F, -2.138F, 0.0F, 0.0F));
		PartDefinition bow_r2 = bow.addOrReplaceChild("bow_r2", CubeListBuilder.create().texOffs(2, 33).addBox(-0.4995F, -0.0397F, -6.0274F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition string2 = string.addOrReplaceChild("string2", CubeListBuilder.create().texOffs(80, 121).addBox(-0.5F, -1.0234F, -6.1133F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0234F, 3.6133F));
		PartDefinition string1 = string.addOrReplaceChild("string1", CubeListBuilder.create().texOffs(31, 33).addBox(-0.5F, -1.0625F, -0.0094F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0625F, -8.4906F));
		PartDefinition arrow = bow.addOrReplaceChild("arrow",
				CubeListBuilder.create().texOffs(14, 125).addBox(-0.4883F, 6.2287F, 0.5369F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(14, 51).addBox(-0.5F, -3.038F, 0.5369F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(16, 51)
						.addBox(-0.5F, -2.438F, 0.5369F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(14, 51).addBox(-0.4805F, -3.038F, 0.5369F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(16, 51)
		...
		PartDefinition bow_r3 = arrow.addOrReplaceChild("bow_r3",
				CubeListBuilder.create().texOffs(17, 52).addBox(-0.5003F, -0.5F, 0.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(17, 52).addBox(-0.5198F, -0.5F, 0.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0198F, -3.081F, 0.8962F, 0.7854F, 0.0F, 0.0F));
		PartDefinition bow_r4 = arrow.addOrReplaceChild("bow_r4",
				CubeListBuilder.create().texOffs(14, 50).addBox(-0.5003F, -0.5F, 1.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(14, 50).addBox(-0.5198F, -0.5F, 1.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0198F, -3.081F, -0.9319F, -0.7854F, 0.0F, 0.0F));
		PartDefinition bow_r5 = arrow.addOrReplaceChild("bow_r5",
				CubeListBuilder.create().texOffs(16, 52).addBox(-0.5003F, -0.5F, 1.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(16, 52).addBox(-0.5198F, -0.5F, 1.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0198F, -2.481F, -0.9319F, -0.7854F, 0.0F, 0.0F));
		PartDefinition bow_r6 = arrow.addOrReplaceChild("bow_r6",
				CubeListBuilder.create().texOffs(28, 38).addBox(-0.5003F, -0.5F, 0.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(28, 38).addBox(-0.5198F, -0.5F, 0.0F, 1.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0198F, -2.481F, 0.8962F, 0.7854F, 0.0F, 0.0F));
		PartDefinition bow_r7 = arrow.addOrReplaceChild("bow_r7", CubeListBuilder.create().texOffs(31, 126).addBox(-0.5003F, -0.5F, 1.0F, 1.0F, 1.0F, -2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.012F, 6.1857F, -0.9319F, -0.7854F, 0.0F, 0.0F));
		PartDefinition bow_r8 = arrow.addOrReplaceChild("bow_r8", CubeListBuilder.create().texOffs(47, 126).addBox(-0.5003F, -0.5F, 1.0F, 1.0F, 1.0F, -2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.012F, 6.1857F, 0.8962F, 0.7854F, 0.0F, 0.0F));
		PartDefinition bow_r9 = arrow.addOrReplaceChild("bow_r9", CubeListBuilder.create().texOffs(14, 50).addBox(-0.4995F, -0.0396F, -1.0274F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0002F, 5.5583F, -0.4641F, 1.5708F, 0.0F, 0.0F));
		PartDefinition bow_r10 = arrow.addOrReplaceChild("bow_r10", CubeListBuilder.create().texOffs(1, 48).addBox(-0.4995F, -0.0396F, -1.0274F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0002F, 1.5583F, -0.4641F, 1.5708F, 0.0F, 0.0F));
		PartDefinition left_arm_main_Group = body.addOrReplaceChild("left_arm_main_Group", CubeListBuilder.create(), PartPose.offsetAndRotation(5.6944F, -13.2901F, -0.0688F, -0.5199F, 0.0653F, 0.1135F));
