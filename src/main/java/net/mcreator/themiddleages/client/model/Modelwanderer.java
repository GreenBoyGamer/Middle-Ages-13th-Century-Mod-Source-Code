...
public class Modelwanderer extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("the_middle_ages", "modelwanderer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(6, 18).addBox(-4.5F, -3.75F, -1.25F, 9.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 47)
						...
						.addBox(-4.25F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(76, 45).addBox(0.2719F, -7.0F, 3.1F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(68, 30)
						.addBox(-4.25F, -4.0F, -2.1F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 70).addBox(3.2833F, -4.0F, -2.1F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(40, 43)
						.addBox(3.2833F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 43).addBox(-4.25F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(40, 43)
						.addBox(3.2833F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r8 = Head.addOrReplaceChild("Head_r8", CubeListBuilder.create().texOffs(35, 50).addBox(0.7547F, -0.7088F, 1.5263F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r10 = Head.addOrReplaceChild("Head_r10", CubeListBuilder.create().texOffs(35, 50).addBox(0.5153F, -0.6582F, 0.2906F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r12 = Head.addOrReplaceChild("Head_r12", CubeListBuilder.create().texOffs(35, 50).addBox(0.5509F, -0.6116F, -0.5576F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 0.8357F, -1.3324F, -0.8031F));
		PartDefinition Head_r13 = Head.addOrReplaceChild("Head_r13", CubeListBuilder.create().texOffs(35, 50).addBox(0.337F, -0.7668F, -1.6515F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.3691F, -2.7122F, 3.9404F, 1.3963F, -1.4399F, -1.3963F));
		PartDefinition Head_r14 = Head.addOrReplaceChild("Head_r14", CubeListBuilder.create().texOffs(35, 50).addBox(0.3487F, -1.0808F, -0.3844F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.3691F, -2.7122F, 3.9404F, 1.3963F, -1.4399F, -1.2654F));
		PartDefinition Head_r15 = Head.addOrReplaceChild("Head_r15", CubeListBuilder.create().texOffs(35, 50).addBox(0.639F, -1.0725F, 0.676F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.3691F, -2.7122F, 3.9404F, 1.4072F, -1.3963F, -1.3635F));
		PartDefinition Head_r16 = Head.addOrReplaceChild("Head_r16", CubeListBuilder.create().texOffs(35, 50).addBox(0.639F, -1.0725F, 0.676F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.6151F, -2.0481F, 3.9404F, 1.4489F, -1.3534F, -1.4043F));
		PartDefinition Head_r17 = Head.addOrReplaceChild("Head_r17", CubeListBuilder.create().texOffs(35, 50).addBox(0.3487F, -1.0808F, -0.3844F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.6151F, -2.0481F, 3.9404F, 1.4725F, -1.3978F, -1.3408F));
		PartDefinition Head_r18 = Head.addOrReplaceChild("Head_r18", CubeListBuilder.create().texOffs(35, 50).addBox(0.337F, -0.7668F, -1.6515F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.6151F, -2.0481F, 3.9404F, 1.44F, -1.3968F, -1.4395F));
		PartDefinition Head_r19 = Head.addOrReplaceChild("Head_r19", CubeListBuilder.create().texOffs(35, 50).addBox(0.5095F, -0.425F, -1.7349F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.4072F, -1.3963F, -1.538F));
		PartDefinition Head_r20 = Head.addOrReplaceChild("Head_r20", CubeListBuilder.create().texOffs(35, 50).addBox(0.6726F, -2.0387F, -1.5898F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.7127F, -1.3963F, -1.538F));
		PartDefinition Head_r21 = Head.addOrReplaceChild("Head_r21", CubeListBuilder.create().texOffs(35, 50).addBox(0.262F, -0.638F, -2.843F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.3963F, -1.4399F, -1.4399F));
		PartDefinition Head_r22 = Head.addOrReplaceChild("Head_r22", CubeListBuilder.create().texOffs(35, 50).addBox(0.4251F, -2.5749F, -2.5825F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.7017F, -1.4399F, -1.4399F));
		PartDefinition Head_r23 = Head.addOrReplaceChild("Head_r23", CubeListBuilder.create().texOffs(35, 50).addBox(0.2077F, -0.01F, -4.0304F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.3963F, -1.4399F, -1.5708F));
		PartDefinition Head_r24 = Head.addOrReplaceChild("Head_r24", CubeListBuilder.create().texOffs(35, 50).addBox(0.3709F, -2.333F, -3.9038F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.7017F, -1.4399F, -1.5708F));
		PartDefinition Head_r25 = Head.addOrReplaceChild("Head_r25", CubeListBuilder.create().texOffs(35, 50).addBox(0.5993F, -3.6124F, -4.1487F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.5708F, -1.4399F, -1.5708F));
		PartDefinition Head_r26 = Head.addOrReplaceChild("Head_r26", CubeListBuilder.create().texOffs(35, 50).addBox(0.6536F, -4.0247F, -2.8703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.5708F, -1.4399F, -1.4399F));
		PartDefinition Head_r27 = Head.addOrReplaceChild("Head_r27", CubeListBuilder.create().texOffs(35, 50).addBox(0.9011F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r30 = Head.addOrReplaceChild("Head_r30", CubeListBuilder.create().texOffs(35, 50).addBox(0.9761F, -3.7445F, 2.0693F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.8346F, -1.355F, -1.9177F));
		PartDefinition Head_r31 = Head
				.addOrReplaceChild(
						"Head_r31", CubeListBuilder.create().texOffs(35, 50).addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
		...
		PartDefinition Head_r32 = Head.addOrReplaceChild("Head_r32", CubeListBuilder.create().texOffs(35, 50).addBox(0.9761F, -3.7445F, 2.0693F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r36 = Head.addOrReplaceChild("Head_r36", CubeListBuilder.create().texOffs(35, 50).addBox(0.9011F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.5818F, -1.3963F, -1.538F));
		PartDefinition Head_r37 = Head.addOrReplaceChild("Head_r37", CubeListBuilder.create().texOffs(35, 50).addBox(0.6536F, -4.0247F, -2.8703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.5708F, -1.4399F, -1.4399F));
		PartDefinition Head_r38 = Head.addOrReplaceChild("Head_r38", CubeListBuilder.create().texOffs(35, 50).addBox(0.5993F, -3.6124F, -4.1487F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.5708F, -1.4399F, -1.5708F));
		PartDefinition Head_r39 = Head.addOrReplaceChild("Head_r39", CubeListBuilder.create().texOffs(35, 50).addBox(0.3709F, -2.333F, -3.9038F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.7017F, -1.4399F, -1.5708F));
		PartDefinition Head_r40 = Head.addOrReplaceChild("Head_r40", CubeListBuilder.create().texOffs(35, 50).addBox(0.2077F, -0.01F, -4.0304F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.3963F, -1.4399F, -1.5708F));
		PartDefinition Head_r41 = Head.addOrReplaceChild("Head_r41", CubeListBuilder.create().texOffs(35, 50).addBox(0.4251F, -2.5749F, -2.5825F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.7017F, -1.4399F, -1.4399F));
		PartDefinition Head_r42 = Head.addOrReplaceChild("Head_r42", CubeListBuilder.create().texOffs(35, 50).addBox(0.262F, -0.638F, -2.843F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.3963F, -1.4399F, -1.4399F));
		PartDefinition Head_r43 = Head.addOrReplaceChild("Head_r43", CubeListBuilder.create().texOffs(35, 50).addBox(0.6726F, -2.0387F, -1.5898F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.7127F, -1.3963F, -1.538F));
		PartDefinition Head_r44 = Head.addOrReplaceChild("Head_r44", CubeListBuilder.create().texOffs(35, 50).addBox(0.5095F, -0.425F, -1.7349F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r46 = Head.addOrReplaceChild("Head_r46", CubeListBuilder.create().texOffs(35, 50).addBox(0.5509F, -0.6116F, -0.5576F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r48 = Head.addOrReplaceChild("Head_r48", CubeListBuilder.create().texOffs(35, 50).addBox(0.5153F, -0.6582F, 0.2906F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r50 = Head.addOrReplaceChild("Head_r50", CubeListBuilder.create().texOffs(35, 50).addBox(0.7547F, -0.7088F, 1.5263F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r53 = Head.addOrReplaceChild("Head_r53", CubeListBuilder.create().texOffs(35, 50).addBox(0.7477F, -1.6524F, 2.2782F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.9655F, -1.355F, -1.9177F));
		PartDefinition Head_r54 = Head.addOrReplaceChild("Head_r54", CubeListBuilder.create().texOffs(35, 50).addBox(0.5845F, -1.2198F, 2.0702F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r56 = Head
				.addOrReplaceChild(
						"Head_r56", CubeListBuilder.create().texOffs(35, 50).addBox(0.8579F, -3.3341F, 2.5703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
								.addBox(0.5188F, -1.1635F, 2.8552F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50).addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.2949F, -4.6757F, -3.8748F, -1.307F, 1.355F, -1.3548F));
		PartDefinition Head_r57 = Head.addOrReplaceChild("Head_r57", CubeListBuilder.create().texOffs(35, 50).addBox(0.9761F, -3.7445F, 2.0693F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7051F, -3.5507F, -3.8748F, -1.307F, 1.355F, -1.2239F));
		PartDefinition Head_r58 = Head.addOrReplaceChild("Head_r58", CubeListBuilder.create().texOffs(35, 50).addBox(1.1463F, -3.3358F, 1.4449F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7051F, -3.5507F, -3.8748F, -1.3653F, 1.3135F, -1.4551F));
		PartDefinition Head_r59 = Head.addOrReplaceChild("Head_r59", CubeListBuilder.create().texOffs(35, 50).addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7051F, -3.5507F, -3.8748F, -1.3061F, 1.3999F, -1.3972F));
		PartDefinition Head_r60 = Head.addOrReplaceChild("Head_r60", CubeListBuilder.create().texOffs(35, 50).addBox(0.9424F, -3.6018F, -0.6242F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7051F, -3.5507F, -3.8748F, -2.1314F, 1.3324F, -2.3385F));
		PartDefinition Head_r61 = Head.addOrReplaceChild("Head_r61", CubeListBuilder.create().texOffs(35, 50).addBox(0.901F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7051F, -3.5507F, -3.8748F, -1.5598F, 1.3963F, -1.6036F));
		PartDefinition Head_r62 = Head.addOrReplaceChild("Head_r62", CubeListBuilder.create().texOffs(35, 50).addBox(0.6536F, -4.0247F, -2.8703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7051F, -3.5507F, -3.8748F, -1.5708F, 1.4399F, -1.7017F));
		PartDefinition Head_r63 = Head.addOrReplaceChild("Head_r63", CubeListBuilder.create().texOffs(35, 50).addBox(0.5993F, -3.6124F, -4.1487F, -1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r65 = Head.addOrReplaceChild("Head_r65", CubeListBuilder.create().texOffs(35, 50).addBox(0.6536F, -4.0247F, -2.8703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.2949F, -4.6757F, -3.8748F, -1.5708F, 1.4399F, -1.7017F));
		PartDefinition Head_r66 = Head.addOrReplaceChild("Head_r66", CubeListBuilder.create().texOffs(35, 50).addBox(0.9011F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r69 = Head.addOrReplaceChild("Head_r69", CubeListBuilder.create().texOffs(35, 50).addBox(0.9761F, -3.7445F, 2.0693F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.2949F, -4.6757F, -3.8748F, -1.307F, 1.355F, -1.2239F));
		PartDefinition Head_r70 = Head.addOrReplaceChild("Head_r70", CubeListBuilder.create().texOffs(35, 50).addBox(0.589F, -0.9431F, 3.1402F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 3.0197F, 0.0459F, -2.9306F));
		PartDefinition Head_r71 = Head.addOrReplaceChild("Head_r71", CubeListBuilder.create().texOffs(35, 50).addBox(0.7522F, -1.0668F, 3.2156F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r73 = Head.addOrReplaceChild("Head_r73", CubeListBuilder.create().texOffs(35, 50).addBox(0.9761F, -3.7445F, 2.0693F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 3.0659F, 0.0729F, -2.9383F));
		PartDefinition Head_r74 = Head.addOrReplaceChild("Head_r74", CubeListBuilder.create().texOffs(35, 50).addBox(0.7477F, -1.6524F, 2.2782F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -3.0863F, 0.0729F, -2.9383F));
		PartDefinition Head_r75 = Head.addOrReplaceChild("Head_r75", CubeListBuilder.create().texOffs(35, 50).addBox(0.5845F, -1.2198F, 2.0702F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r77 = Head.addOrReplaceChild("Head_r77", CubeListBuilder.create().texOffs(35, 50).addBox(0.9179F, -1.3287F, 1.6058F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r80 = Head.addOrReplaceChild("Head_r80", CubeListBuilder.create().texOffs(35, 50).addBox(0.9424F, -3.6018F, -0.6242F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.9489F, -0.1647F, -2.9685F));
		PartDefinition Head_r81 = Head.addOrReplaceChild("Head_r81", CubeListBuilder.create().texOffs(35, 50).addBox(0.714F, -1.8626F, -0.4108F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.818F, -0.1647F, -2.9685F));
		PartDefinition Head_r82 = Head.addOrReplaceChild("Head_r82", CubeListBuilder.create().texOffs(35, 50).addBox(0.6784F, -1.6519F, 0.4122F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.9171F, 0.0294F, -2.9732F));
		PartDefinition Head_r83 = Head.addOrReplaceChild("Head_r83", CubeListBuilder.create().texOffs(35, 50).addBox(0.5153F, -0.6582F, 0.2906F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 3.0607F, 0.0294F, -2.9732F));
		PartDefinition Head_r84 = Head.addOrReplaceChild("Head_r84", CubeListBuilder.create().texOffs(35, 50).addBox(0.5509F, -0.6116F, -0.5576F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -3.1234F, -0.1647F, -2.9685F));
		PartDefinition Head_r85 = Head.addOrReplaceChild("Head_r85", CubeListBuilder.create().texOffs(35, 50).addBox(0.5F, -1.0F, -0.5F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9867F, -3.0675F, -2.1954F, -3.1019F, -0.1609F, -3.1011F));
		PartDefinition Head_r86 = Head.addOrReplaceChild("Head_r86", CubeListBuilder.create().texOffs(35, 50).addBox(0.5F, -1.0F, -0.5F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9867F, -3.5675F, 0.3046F, -3.1019F, -0.1609F, -3.1011F));
		PartDefinition Head_r87 = Head.addOrReplaceChild("Head_r87", CubeListBuilder.create().texOffs(35, 50).addBox(0.5095F, -0.425F, -1.7349F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 3.0103F, -0.0057F, -2.9672F));
		PartDefinition Head_r88 = Head.addOrReplaceChild("Head_r88", CubeListBuilder.create().texOffs(35, 50).addBox(0.6726F, -2.0387F, -1.5898F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.9674F, -0.0057F, -2.9672F));
		PartDefinition Head_r89 = Head.addOrReplaceChild("Head_r89", CubeListBuilder.create().texOffs(35, 50).addBox(0.901F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -3.0983F, -0.0057F, -2.9672F));
		PartDefinition Head_r90 = Head.addOrReplaceChild("Head_r90", CubeListBuilder.create().texOffs(35, 50).addBox(0.6536F, -4.0247F, -2.8703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -3.0118F, -0.017F, -3.0118F));
		PartDefinition Head_r91 = Head.addOrReplaceChild("Head_r91", CubeListBuilder.create().texOffs(35, 50).addBox(0.4251F, -2.5749F, -2.5825F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.8809F, -0.017F, -3.0118F));
		PartDefinition Head_r92 = Head.addOrReplaceChild("Head_r92", CubeListBuilder.create().texOffs(35, 50).addBox(0.262F, -0.638F, -2.843F, -1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 3.0969F, -0.017F, -3.0118F));
		PartDefinition Head_r93 = Head.addOrReplaceChild("Head_r93", CubeListBuilder.create().texOffs(35, 50).addBox(0.3709F, -2.333F, -3.9038F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -3.0107F, 0.0F, -3.0107F));
		PartDefinition Head_r94 = Head.addOrReplaceChild("Head_r94", CubeListBuilder.create().texOffs(35, 50).addBox(0.2077F, -0.01F, -4.0304F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 2.9671F, 0.0F, -3.0107F));
		PartDefinition Head_r95 = Head.addOrReplaceChild("Head_r95", CubeListBuilder.create().texOffs(35, 50).addBox(0.5993F, -3.6124F, -4.1487F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, 3.1416F, 0.0F, -3.0107F));
		PartDefinition Head_r96 = Head.addOrReplaceChild("Head_r96", CubeListBuilder.create().texOffs(35, 50).addBox(0.8579F, -3.3341F, 2.5703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.2051F, -4.6757F, 0.1252F, -3.0889F, 0.0459F, -2.9306F));
		PartDefinition Head_r97 = Head.addOrReplaceChild("Head_r97", CubeListBuilder.create().texOffs(35, 50).addBox(0.9277F, -3.7188F, -1.1324F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.2051F, -4.6757F, 0.1252F, -2.9489F, -0.1647F, -2.9685F));
		PartDefinition Head_r98 = Head.addOrReplaceChild("Head_r98", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0555F, -3.488F, 3.5836F, 0.0527F, -0.0459F, -0.211F));
		PartDefinition Head_r99 = Head.addOrReplaceChild("Head_r99", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8055F, -3.488F, 3.5836F, 0.1836F, -0.0459F, -0.211F));
		PartDefinition Head_r100 = Head.addOrReplaceChild("Head_r100", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8055F, -3.488F, 3.5836F, -0.1219F, -0.0459F, -0.211F));
		PartDefinition Head_r101 = Head.addOrReplaceChild("Head_r101", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8055F, -5.6677F, 3.7125F, -0.1219F, -0.0459F, -0.211F));
		PartDefinition Head_r102 = Head.addOrReplaceChild("Head_r102", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8055F, -5.6677F, 3.7125F, 0.1836F, -0.0459F, -0.211F));
		PartDefinition Head_r103 = Head.addOrReplaceChild("Head_r103", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9539F, -5.6677F, 3.2008F, 0.0527F, -0.0459F, -0.211F));
		PartDefinition Head_r104 = Head.addOrReplaceChild("Head_r104", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9141F, -5.7732F, 1.5328F, 0.0936F, -0.0294F, -0.2556F));
		PartDefinition Head_r105 = Head.addOrReplaceChild("Head_r105", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8008F, -5.7732F, 0.2906F, 0.0936F, -0.0294F, -0.1684F));
		PartDefinition Head_r106 = Head.addOrReplaceChild("Head_r106", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0508F, -5.7732F, -0.7094F, 0.1927F, 0.1647F, -0.1731F));
		PartDefinition Head_r107 = Head.addOrReplaceChild("Head_r107", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8055F, -5.6677F, 3.7125F, 0.0527F, -0.0459F, -0.211F));
		PartDefinition Head_r108 = Head.addOrReplaceChild("Head_r108", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7625F, -5.7263F, 2.8453F, -0.0757F, -0.0729F, -0.2033F));
		PartDefinition Head_r109 = Head.addOrReplaceChild("Head_r109", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0125F, -5.7263F, 2.8453F, 0.0552F, -0.0729F, -0.2033F));
		PartDefinition Head_r110 = Head.addOrReplaceChild("Head_r110", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4732F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0125F, -5.7263F, 2.8453F, -0.2502F, -0.0729F, -0.2033F));
		PartDefinition Head_r111 = Head.addOrReplaceChild("Head_r111", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0156F, -5.7732F, 2.0445F, -0.0809F, -0.0294F, -0.2556F));
		PartDefinition Head_r112 = Head.addOrReplaceChild("Head_r112", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -3.0505F, 1.0953F, 0.2245F, -0.0294F, -0.1684F));
		PartDefinition Head_r113 = Head.addOrReplaceChild("Head_r113", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -3.0505F, 0.0953F, 0.3236F, 0.1647F, -0.1731F));
		PartDefinition Head_r114 = Head.addOrReplaceChild("Head_r114", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0156F, -3.0505F, 2.3375F, 0.2245F, -0.0294F, -0.2556F));
		PartDefinition Head_r115 = Head.addOrReplaceChild("Head_r115", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0156F, -5.7732F, 2.0445F, 0.2245F, -0.0294F, -0.2556F));
		PartDefinition Head_r116 = Head.addOrReplaceChild("Head_r116", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0156F, -5.7732F, 2.0445F, 0.0936F, -0.0294F, -0.2556F));
		PartDefinition Head_r117 = Head.addOrReplaceChild("Head_r117", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, 0.8023F, 0.0936F, -0.0294F, -0.1684F));
		PartDefinition Head_r118 = Head.addOrReplaceChild("Head_r118", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, 0.8023F, 0.2245F, -0.0294F, -0.1684F));
		PartDefinition Head_r119 = Head.addOrReplaceChild("Head_r119", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, 0.8023F, -0.0809F, -0.0294F, -0.1684F));
		PartDefinition Head_r120 = Head.addOrReplaceChild("Head_r120", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, -0.1977F, 0.0182F, 0.1647F, -0.1731F));
		PartDefinition Head_r121 = Head.addOrReplaceChild("Head_r121", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, -0.1977F, 0.3236F, 0.1647F, -0.1731F));
		PartDefinition Head_r122 = Head.addOrReplaceChild("Head_r122", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, -0.1977F, 0.1927F, 0.1647F, -0.1731F));
		PartDefinition Head_r123 = Head.addOrReplaceChild("Head_r123", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, -1.1898F, 0.0433F, 0.0057F, -0.1744F));
		PartDefinition Head_r124 = Head.addOrReplaceChild("Head_r124", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, -1.1898F, 0.1742F, 0.0057F, -0.1744F));
		PartDefinition Head_r125 = Head.addOrReplaceChild("Head_r125", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.9023F, -5.7732F, -1.1898F, -0.1313F, 0.0057F, -0.1744F));
		PartDefinition Head_r126 = Head.addOrReplaceChild("Head_r126", CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6523F, -5.8787F, -2.3734F, -0.0447F, 0.017F, -0.1298F));
		PartDefinition Head_r127 = Head.addOrReplaceChild("Head_r127", CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6523F, -5.8787F, -2.3734F, 0.2607F, 0.017F, -0.1298F));
		PartDefinition Head_r128 = Head.addOrReplaceChild("Head_r128", CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6523F, -5.8787F, -2.3734F, 0.1298F, 0.017F, -0.1298F));
		PartDefinition Head_r129 = Head.addOrReplaceChild("Head_r129", CubeListBuilder.create().texOffs(35, 50).addBox(0.5F, -1.0F, -0.5F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6523F, -4.2786F, -3.5234F, -0.1745F, 0.0F, -0.1309F));
		PartDefinition Head_r130 = Head.addOrReplaceChild("Head_r130", CubeListBuilder.create().texOffs(35, 50).addBox(0.5F, -1.0F, -0.5F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6523F, -5.5286F, -3.4234F, 0.1309F, 0.0F, -0.1309F));
		PartDefinition Head_r131 = Head.addOrReplaceChild("Head_r131", CubeListBuilder.create().texOffs(35, 50).addBox(0.5F, -1.0F, -0.5F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.6523F, -7.2786F, -3.5234F, 0.0F, 0.0F, -0.1309F));
		PartDefinition Head_r132 = Head.addOrReplaceChild("Head_r132", CubeListBuilder.create().texOffs(58, 24).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0833F, -2.3957F, -3.6816F, -0.3491F, 0.0F, 0.0F));
		PartDefinition eyebrow = Head.addOrReplaceChild("eyebrow", CubeListBuilder.create(), PartPose.offset(3.8333F, 24.6F, -0.0258F));
		PartDefinition Head_r133 = eyebrow.addOrReplaceChild("Head_r133", CubeListBuilder.create().texOffs(105, 63).addBox(-2.0F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.2234F, -26.0833F, -3.6F, -0.3054F, 0.0F, 0.0F));
		PartDefinition Head_r134 = eyebrow.addOrReplaceChild("Head_r134",
		...
		PartDefinition mouth = Head.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(52, 37).addBox(-1.0F, 0.1667F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0833F, -1.3833F, -3.5258F));
		PartDefinition smile_frown = mouth.addOrReplaceChild("smile_frown", CubeListBuilder.create(), PartPose.offset(2.0F, 28.5F, 3.5F));
		PartDefinition frown_L = smile_frown.addOrReplaceChild("frown_L", CubeListBuilder.create().texOffs(52, 37).addBox(-0.1716F, -0.5507F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9727F, -27.7984F, -3.5F, 0.0F, 0.0F, -0.2182F));
		PartDefinition frown_R = smile_frown.addOrReplaceChild("frown_R", CubeListBuilder.create().texOffs(52, 37).addBox(-0.8574F, -0.5421F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0401F, -27.8112F, -3.5F, 0.0F, 0.0F, 0.2182F));
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(3, 27).addBox(-1.5F, 2.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						.addBox(-0.5F, 2.0117F, -2.557F, 1.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37).addBox(-0.5F, 6.9117F, -2.557F, 1.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						...
						.addBox(-4.6F, 9.0F, -2.6F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(68, 22).addBox(-4.5F, -0.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(1.5F, -0.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(66, 1).addBox(-4.05F, 8.5F, -3.4F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(114, 5)
						.addBox(0.95F, 7.4167F, -3.4F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1).addBox(-4.15F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
						.addBox(-2.95F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1).addBox(-3.55F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(92, 7)
						.addBox(-1.0F, 9.1617F, -2.6599F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 7).addBox(-1.0F, 8.7617F, -2.657F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 7)
						.addBox(0.0F, 8.7617F, -2.657F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 7).addBox(0.0F, 9.1617F, -2.6599F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -13.0F, 0.0F));
		...
		PartDefinition Body_r4 = Body.addOrReplaceChild("Body_r4", CubeListBuilder.create().texOffs(12, 75).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 4.6117F, -0.157F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r5 = Body.addOrReplaceChild("Body_r5", CubeListBuilder.create().texOffs(0, 75).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.9117F, -0.157F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r6 = Body.addOrReplaceChild("Body_r6", CubeListBuilder.create().texOffs(3, 27).addBox(-1.5F, -2.5F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8078F, 14.25F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition Body_r7 = Body.addOrReplaceChild("Body_r7", CubeListBuilder.create().texOffs(2, 27).addBox(-2.5F, -2.5F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.7313F, 14.25F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition Body_r8 = Body.addOrReplaceChild("Body_r8", CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -5.0F, -2.5005F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.2617F, 7.0F, 0.0F, 0.0F, 0.0F, 0.0436F));
		PartDefinition Body_r9 = Body.addOrReplaceChild("Body_r9", CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -5.0F, -2.5005F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.293F, 7.0F, 0.0F, 0.0F, 0.0F, -0.0436F));
		PartDefinition LeftArm = Waist.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(50, 62).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(50, 62).addBox(-1.0F, 2.5F, -2.25F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(50, 62)
						.addBox(-1.2F, 2.5F, -1.75F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(53, 65).addBox(-1.2F, 2.5F, -2.25F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 62)
						.addBox(-0.6F, 2.5F, -2.25F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(50, 62).addBox(-0.8F, 2.5F, -1.75F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.5F, -11.0F, 0.0F));
		PartDefinition Body_r10 = LeftArm.addOrReplaceChild("Body_r10", CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0081F, -0.8359F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition Body_r11 = LeftArm.addOrReplaceChild("Body_r11", CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7081F, -0.8359F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition LeftArm2 = LeftArm.addOrReplaceChild("LeftArm2", CubeListBuilder.create().texOffs(58, 37).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 4.5F, 0.0F, 0.0F, 0.0F, 0.0436F));
		...
		PartDefinition leave = carrot.addOrReplaceChild("leave", CubeListBuilder.create(), PartPose.offset(-0.2313F, -1.4166F, -1.1111F));
		...
		PartDefinition leave2 = carrot.addOrReplaceChild("leave2", CubeListBuilder.create(), PartPose.offset(-0.2313F, -1.4166F, 0.2222F));
		PartDefinition LeftArm_r4 = leave2.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition leave3 = carrot.addOrReplaceChild("leave3", CubeListBuilder.create(), PartPose.offset(0.4354F, -1.4166F, 0.2222F));
		...
		PartDefinition LeftArm_r7 = carrot2.addOrReplaceChild("LeftArm_r7", CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2938F, 0.3061F, 0.2222F, 0.0F, 0.0F, -0.1309F));
		PartDefinition leave4 = carrot2.addOrReplaceChild("leave4", CubeListBuilder.create(), PartPose.offset(-0.2313F, -1.4166F, -1.1111F));
		PartDefinition LeftArm_r8 = leave4.addOrReplaceChild("LeftArm_r8", CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition leave5 = carrot2.addOrReplaceChild("leave5", CubeListBuilder.create(), PartPose.offset(-0.2313F, -1.4166F, 0.2222F));
		PartDefinition LeftArm_r9 = leave5.addOrReplaceChild("LeftArm_r9", CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition leave6 = carrot2.addOrReplaceChild("leave6", CubeListBuilder.create(), PartPose.offset(0.4354F, -1.4166F, 0.2222F));
		...
		PartDefinition LeftArm_r12 = carrot3.addOrReplaceChild("LeftArm_r12", CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2938F, 0.3061F, 0.2222F, 0.0F, 0.0F, -0.1309F));
		PartDefinition leave7 = carrot3.addOrReplaceChild("leave7", CubeListBuilder.create(), PartPose.offset(-0.2313F, -1.4166F, -1.1111F));
		PartDefinition LeftArm_r13 = leave7.addOrReplaceChild("LeftArm_r13", CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition leave8 = carrot3.addOrReplaceChild("leave8", CubeListBuilder.create(), PartPose.offset(-0.2313F, -1.4166F, 0.2222F));
		PartDefinition LeftArm_r14 = leave8.addOrReplaceChild("LeftArm_r14", CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition leave9 = carrot3.addOrReplaceChild("leave9", CubeListBuilder.create(), PartPose.offset(0.4354F, -1.4166F, 0.2222F));
		...
		PartDefinition Body_r12 = RightArm.addOrReplaceChild("Body_r12", CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.1667F, -0.8359F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition Body_r13 = RightArm.addOrReplaceChild("Body_r13", CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.9167F, -0.8359F, 0.0F, 0.0F, 0.0F, 0.0873F));
