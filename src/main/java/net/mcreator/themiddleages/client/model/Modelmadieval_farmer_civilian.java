...
public class Modelmadieval_farmer_civilian extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("the_middle_ages", "modelmadieval_farmer_civilian"), "main");
	...
	public Modelmadieval_farmer_civilian(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(6, 18).addBox(-4.5F, -3.75F, -1.25F, 9.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 47)
						...
						.addBox(-4.25F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(74, 37).addBox(-4.0F, -7.0F, 3.1F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(76, 45)
						...
						.addBox(-4.25F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(40, 43).addBox(3.2833F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(-4.75F, -6.4167F, -4.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 33).addBox(-0.25F, -6.4167F, -4.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(-4.75F, -6.4167F, -0.25F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 33).addBox(-0.25F, -6.4167F, -0.25F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -13.0F, 0.0F));
		PartDefinition Body_r1 = Head.addOrReplaceChild("Body_r1", CubeListBuilder.create().texOffs(-1, 37).addBox(-2.5F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.755F, -4.3609F, -0.4594F, 0.2531F, -0.3279F, -1.4073F));
		PartDefinition Body_r2 = Head.addOrReplaceChild("Body_r2", CubeListBuilder.create().texOffs(0, 37).addBox(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.1612F, -4.6226F, 1.1773F, 0.4087F, 0.7554F, -1.2076F));
		PartDefinition Body_r3 = Head.addOrReplaceChild("Body_r3", CubeListBuilder.create().texOffs(2, 36).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.75F, -6.1667F, 0.0F, 0.8043F, 0.0398F, -0.2757F));
		...
		PartDefinition Head_r132 = Head.addOrReplaceChild("Head_r132", CubeListBuilder.create().texOffs(58, 24).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(3, 27).addBox(-1.5F, 2.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						...
						.addBox(1.5F, -0.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(66, 1).addBox(-4.05F, 8.5F, -3.4F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
				...
				PartPose.offset(0.5F, -13.0F, 0.0F));
		PartDefinition Body_r4 = Body.addOrReplaceChild("Body_r4", CubeListBuilder.create().texOffs(66, 1).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.15F, 9.0273F, -3.1F, 0.0F, 0.7854F, 0.0F));
		PartDefinition Body_r5 = Body.addOrReplaceChild("Body_r5", CubeListBuilder.create().texOffs(76, 14).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.0117F, -0.157F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r6 = Body.addOrReplaceChild("Body_r6", CubeListBuilder.create().texOffs(76, 8).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 6.3117F, -0.157F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r7 = Body.addOrReplaceChild("Body_r7", CubeListBuilder.create().texOffs(12, 75).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 4.6117F, -0.157F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r8 = Body.addOrReplaceChild("Body_r8", CubeListBuilder.create().texOffs(0, 75).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.9117F, -0.157F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r9 = Body.addOrReplaceChild("Body_r9", CubeListBuilder.create().texOffs(3, 27).addBox(-1.5F, -2.5F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8078F, 14.25F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition Body_r10 = Body.addOrReplaceChild("Body_r10", CubeListBuilder.create().texOffs(2, 27).addBox(-2.5F, -2.5F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.7313F, 14.25F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition Body_r11 = Body.addOrReplaceChild("Body_r11", CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -5.0F, -2.5005F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.2617F, 7.0F, 0.0F, 0.0F, 0.0F, 0.0436F));
		PartDefinition Body_r12 = Body.addOrReplaceChild("Body_r12", CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -5.0F, -2.5005F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r13 = LeftArm.addOrReplaceChild("Body_r13", CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0081F, -0.8359F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition Body_r14 = LeftArm.addOrReplaceChild("Body_r14", CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r15 = RightArm.addOrReplaceChild("Body_r15", CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.1667F, -0.8359F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition Body_r16 = RightArm.addOrReplaceChild("Body_r16", CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
