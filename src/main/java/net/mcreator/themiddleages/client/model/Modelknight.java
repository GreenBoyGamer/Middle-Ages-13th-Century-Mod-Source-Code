...
public class Modelknight extends EntityModel<LivingEntityRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm_r3 = RightArm2.addOrReplaceChild(
				"RightArm_r3", CubeListBuilder.create().texOffs(-3, 0).mirror().addBox(0.0F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(-3, 0).mirror()
						.addBox(0.5F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(-3, 0).mirror().addBox(0.25F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftArm_r4 = LeftArm.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(-3, 0).mirror().addBox(0.0F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(-3, 0).mirror()
				.addBox(0.5F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.7587F, -0.1635F, 24.1878F, -0.7854F, 0.0F, 0.0F));
