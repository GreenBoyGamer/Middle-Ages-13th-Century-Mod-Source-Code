...
public class Modelknight extends EntityModel<LivingEntityRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.3976F, -8.0937F, -4.4593F, 1.0F, 3.0F, 8.5F, new CubeDeformation(0.0F)).texOffs(98, 100).addBox(-3.2976F, -7.9937F, 3.8907F, 6.4F, 8.0F, 0.05F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(16, 102).addBox(-4.3151F, -4.2687F, -1.9025F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(68, 43).addBox(-4.3151F, -4.2687F, -2.0025F, 7.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						...
						.addBox(2.0849F, -4.2687F, -1.8025F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(90, 8).addBox(-1.0029F, -9.1073F, -1.94F, 2.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(88, 22)
						.addBox(-3.0029F, -7.1073F, -1.94F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(90, 34).addBox(-1.0029F, -9.1073F, -1.8657F, 2.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(92, 28)
		...
		PartDefinition Body_r5 = Body.addOrReplaceChild("Body_r5", CubeListBuilder.create().texOffs(42, 49).addBox(-1.1292F, -5.0708F, -1.9F, 5.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, 0.5975F, -0.0872F, 0.0038F, -3.0981F));
		PartDefinition Body_r6 = Body.addOrReplaceChild("Body_r6", CubeListBuilder.create().texOffs(60, 61).addBox(-3.3718F, -5.049F, -1.9F, 4.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, 0.5975F, -0.0872F, -0.0038F, 3.0981F));
		PartDefinition Body_r7 = Body.addOrReplaceChild("Body_r7", CubeListBuilder.create().texOffs(32, 93).addBox(-3.3718F, -5.049F, -1.9F, 2.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.1961F, 0.7054F, -0.5025F, 0.0872F, -0.0038F, -3.0981F));
		PartDefinition Body_r8 = Body.addOrReplaceChild("Body_r8", CubeListBuilder.create().texOffs(86, 92).addBox(-3.3718F, -5.049F, -1.9F, 2.0F, 10.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, -0.5025F, 0.0872F, 0.0038F, 3.0981F));
		PartDefinition Body_r9 = Body.addOrReplaceChild("Body_r9", CubeListBuilder.create().texOffs(20, 69).addBox(-3.3718F, -3.049F, -1.9F, 4.0F, 8.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, -0.4025F, 0.0872F, 0.0038F, 3.0981F));
		PartDefinition Body_r10 = Body.addOrReplaceChild("Body_r10", CubeListBuilder.create().texOffs(44, 24).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1849F, -3.7687F, -1.6025F, 0.0F, 0.0F, 0.7854F));
		PartDefinition Body_r11 = Body.addOrReplaceChild("Body_r11", CubeListBuilder.create().texOffs(60, 49).addBox(-1.1292F, -3.0708F, -1.9F, 5.0F, 8.0F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, 0.8054F, -0.4025F, 0.0872F, -0.0038F, -3.0981F));
		PartDefinition Body_r12 = Body.addOrReplaceChild("Body_r12", CubeListBuilder.create().texOffs(32, 83).addBox(-0.6357F, -2.3256F, -1.9F, 5.0F, 5.5667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, -0.8597F, 0.0975F, 0.0F, 0.0F, -3.098F));
		PartDefinition Body_r13 = Body.addOrReplaceChild("Body_r13", CubeListBuilder.create().texOffs(92, 59).addBox(-3.8653F, -2.3039F, -1.9F, 4.0F, 5.5667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1706F, -0.8597F, 0.0975F, 0.0F, 0.0F, 3.098F));
		PartDefinition Body_r14 = Body.addOrReplaceChild("Body_r14", CubeListBuilder.create().texOffs(42, 63).addBox(-0.964F, -6.578F, -1.8625F, 5.0F, 6.6667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1389F, -4.196F, 0.06F, 0.0F, 0.0F, 0.0436F));
		PartDefinition Body_r15 = Body.addOrReplaceChild("Body_r15", CubeListBuilder.create().texOffs(86, 81).addBox(-3.9176F, -6.5728F, -1.8625F, 4.0F, 6.6667F, 3.8F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1389F, -4.196F, 0.06F, 0.0F, 0.0F, -0.0436F));
		...
		PartDefinition Right_Arm2 = RightArm.addOrReplaceChild("Right_Arm2", CubeListBuilder.create().texOffs(0, 87).addBox(-2.035F, 0.0031F, -2.043F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 97)
				.addBox(0.75F, 3.75F, -3.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(91, 102).addBox(0.7587F, 3.1512F, -20.7552F, 1.0F, 2.1F, 17.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 4.0F, 0.0F));
		PartDefinition RightArm_r3 = Right_Arm2.addOrReplaceChild("RightArm_r3", CubeListBuilder.create().texOffs(-3, 0).mirror().addBox(0.0F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.75F, 4.25F, 3.7F, -0.7854F, 0.0F, 0.0F));
		PartDefinition RightArm_r4 = Right_Arm2.addOrReplaceChild("RightArm_r4", CubeListBuilder.create().texOffs(-1, 0).mirror().addBox(0.0F, -1.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.75F, 4.7656F, -3.3F, -0.0873F, 0.0F, 0.0F));
		PartDefinition RightArm_r5 = Right_Arm2.addOrReplaceChild("RightArm_r5", CubeListBuilder.create().texOffs(-1, 0).mirror().addBox(0.0F, -2.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.75F, 3.75F, -3.3F, 0.0873F, 0.0F, 0.0F));
		PartDefinition RightArm_r6 = Right_Arm2.addOrReplaceChild("RightArm_r6", CubeListBuilder.create().texOffs(37, 19).addBox(-0.5F, -1.05F, -0.793F, 1.0F, 1.4164F, 1.543F, new CubeDeformation(0.0F)),
		...
		PartDefinition Right_Arm4 = Left_Arm.addOrReplaceChild("Right_Arm4", CubeListBuilder.create().texOffs(16, 92).addBox(-2.035F, -0.0031F, -2.043F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(98, 92)
				.addBox(-1.9167F, 3.75F, -3.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(88, 105).mirror().addBox(-1.9254F, 3.1512F, -20.7552F, 1.0F, 2.1F, 17.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-1.0F, 4.0F, 0.0F));
		PartDefinition LeftArm_r3 = Right_Arm4.addOrReplaceChild("LeftArm_r3", CubeListBuilder.create().texOffs(42, 17).addBox(-0.5F, -1.05F, -0.793F, 1.0F, 1.4164F, 1.543F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.408F, 4.4135F, -20.4878F, 0.829F, 0.0F, 0.0F));
		PartDefinition LeftArm_r4 = Right_Arm4.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(-3, 0).mirror().addBox(0.0F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.9167F, 4.25F, 3.7F, -0.7854F, 0.0F, 0.0F));
		PartDefinition LeftArm_r5 = Right_Arm4.addOrReplaceChild("LeftArm_r5", CubeListBuilder.create().texOffs(-1, 0).mirror().addBox(0.0F, -1.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.9167F, 4.7656F, -3.3F, -0.0873F, 0.0F, 0.0F));
		PartDefinition LeftArm_r6 = Right_Arm4.addOrReplaceChild("LeftArm_r6", CubeListBuilder.create().texOffs(-1, 0).mirror().addBox(0.0F, -2.5F, 0.5F, 1.0F, 4.0F, -1.0F, new CubeDeformation(0.0F)).mirror(false),
