...
import net.mcreator.themiddleages.client.model.animations.madieval_passenger_cart_operatorAnimation;
import net.mcreator.themiddleages.client.model.Modelmadieval_passenger_cart_operator;

import java.util.Map;

public class PassengerCartRidingRenderer extends MobRenderer<PassengerCartRidingEntity, LivingEntityRenderState, Modelmadieval_passenger_cart_operator> {
	...
	public PassengerCartRidingRenderer(EntityRendererProvider.Context context) {
		super(context, new AnimatedModel(context.bakeLayer(Modelmadieval_passenger_cart_operator.LAYER_LOCATION)), 0.5f);
	}
	...
	private static final class AnimatedModel extends Modelmadieval_passenger_cart_operator {
		...
		public AnimatedModel(ModelPart root) {
			super(root);
			this.keyframeAnimation0 = safeBake(madieval_passenger_cart_operatorAnimation.idle);
			this.keyframeAnimation1 = safeBake(madieval_passenger_cart_operatorAnimation.moving);
			this.keyframeAnimation2 = safeBake(madieval_passenger_cart_operatorAnimation.die);
		}
