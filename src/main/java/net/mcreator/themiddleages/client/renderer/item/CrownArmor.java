...
import net.mcreator.themiddleages.client.model.Modelcrown;

import java.util.Map;
import java.util.Collections;

@EventBusSubscriber(Dist.CLIENT)
public class CrownArmor {
	@SubscribeEvent
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("the_middle_ages:textures/entities/crown.png");
				...
				if (armorModel == null) {
					armorModel = new HumanoidModel<>(new ModelPart(Collections.emptyList(), Map.of("head",
							new ModelPart(Collections.emptyList(),
									Map.of("head", new Modelcrown(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcrown.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))),
		...
		}, TheMiddleAgesModItems.CROWN_HELMET.get());
	}
}