...
public class SitRenderer extends HumanoidMobRenderer<SitEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	...
	@Override
	public void extractRenderState(SitEntity entity, HumanoidRenderState state, float partialTicks) {
