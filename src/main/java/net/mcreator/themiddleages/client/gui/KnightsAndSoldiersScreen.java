...
public class KnightsAndSoldiersScreen extends AbstractContainerScreen<KnightsAndSoldiersMenu> implements TheMiddleAgesModScreens.ScreenAccessor {
	...
	private ImageButton imagebutton_basebuttons6;
	private ImageButton imagebutton_basebuttons7;
	private ImageButton imagebutton_basebuttons8;
	private ImageButton imagebutton_basebuttons9;
	...
	private static final Identifier IMAGE_15 = Identifier.parse("the_middle_ages:textures/screens/backgroundbasetwo.png");
	private static final Identifier IMAGE_16 = Identifier.parse("the_middle_ages:textures/screens/backgroundbasetwo.png");
	private static final Identifier IMAGE_17 = Identifier.parse("the_middle_ages:textures/screens/wealth.png");
	private static final Identifier IMAGE_18 = Identifier.parse("the_middle_ages:textures/screens/wealth.png");
	private static final Identifier IMAGE_19 = Identifier.parse("the_middle_ages:textures/screens/swordclashiamge.png");
	...
	public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_15, this.leftPos + 139, this.topPos + -4, 0, 0, 128, 64, 128, 64);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_16, this.leftPos + -99, this.topPos + -17, 0, 0, 128, 64, 128, 64);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_17, this.leftPos + -16, this.topPos + 0, 0, 0, 16, 16, 16, 16);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_18, this.leftPos + -16, this.topPos + 20, 0, 0, 16, 16, 16, 16);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_19, this.leftPos + 68, this.topPos + -34, 0, 0, 32, 32, 32, 32);
	}
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_knight"), 31, 57, -16777216, false);
		...
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_spawn_civilians"), 142, -1, -16777216, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_farmer"), 137, 16, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_wagoner"), 198, 15, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_lisa"), 141, 36, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_alice"), 206, 35, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_john"), 238, -5, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_seller_buyer"), -72, -13, -16777216, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_bread_seller"), -87, 4, -16777216, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_exchanger"), -84, 23, -16777216, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_x8"), -24, 2, -16777216, false);
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.knights_and_soldiers.label_x81"), -24, 22, -16777216, false);
	}
	...
	public void init() {
		...
		imagebutton_basebuttons3 = new ImageButton(this.leftPos + 127, this.topPos + 14, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(3, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_basebuttons4 = new ImageButton(this.leftPos + 193, this.topPos + 13, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(4, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_basebuttons5 = new ImageButton(this.leftPos + 127, this.topPos + 34, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(5, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_basebuttons6 = new ImageButton(this.leftPos + 193, this.topPos + 33, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(6, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 6, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		this.addRenderableWidget(imagebutton_basebuttons6);
		imagebutton_basebuttons7 = new ImageButton(this.leftPos + 226, this.topPos + -7, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(7, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 7, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		this.addRenderableWidget(imagebutton_basebuttons7);
		imagebutton_basebuttons8 = new ImageButton(this.leftPos + -90, this.topPos + 2, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(8, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 8, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		this.addRenderableWidget(imagebutton_basebuttons8);
		imagebutton_basebuttons9 = new ImageButton(this.leftPos + -90, this.topPos + 21, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					int x = KnightsAndSoldiersScreen.this.x;
					int y = KnightsAndSoldiersScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new KnightsAndSoldiersButtonMessage(9, x, y, z));
						KnightsAndSoldiersButtonMessage.handleButtonAction(entity, 9, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		this.addRenderableWidget(imagebutton_basebuttons9);
	}
}