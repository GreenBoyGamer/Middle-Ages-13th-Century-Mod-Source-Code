...
public class Civilian3GUIScreen extends AbstractContainerScreen<Civilian3GUIMenu> implements TheMiddleAgesModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.text(this.font, Component.translatable("gui.the_middle_ages.civilian_3_gui.label_help"), 103, 112, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_basebuttons2 = new ImageButton(this.leftPos + 83, this.topPos + 111, 64, 16,
				new WidgetSprites(Identifier.parse("the_middle_ages:textures/screens/basebuttons.png"), Identifier.parse("the_middle_ages:textures/screens/basebuttonhover.png")), e -> {
					...
					int y = Civilian3GUIScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Civilian3GUIButtonMessage(2, x, y, z));
						Civilian3GUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
