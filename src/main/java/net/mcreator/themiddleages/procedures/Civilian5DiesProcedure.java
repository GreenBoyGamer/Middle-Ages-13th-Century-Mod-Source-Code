...
public class Civilian5DiesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		TheMiddleAgesModVariables.MapVariables.get(world).Wealth = TheMiddleAgesModVariables.MapVariables.get(world).Wealth - 25;
		TheMiddleAgesModVariables.MapVariables.get(world).markSyncDirty();
		...
		if (entity instanceof Civilian5Entity _datEntSetI)
			_datEntSetI.getEntityData().set(Civilian5Entity.DATA_TimeToDie, 1);
		if (entity instanceof Civilian5Entity _datEntSetI)
