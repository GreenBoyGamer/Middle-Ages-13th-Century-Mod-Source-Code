	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (actionState == 0) {
				...
				if (actionState < 4) {
					AttackDamage = entity instanceof LivingEntity _livingEntity142 && _livingEntity142.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity142.getAttribute(Attributes.ATTACK_DAMAGE).getValue() : 0;
