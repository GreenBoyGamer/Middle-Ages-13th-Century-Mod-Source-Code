	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (actionState == 0) {
				...
				if (actionState < 3) {
					AttackDamage = entity instanceof LivingEntity _livingEntity88 && _livingEntity88.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity88.getAttribute(Attributes.ATTACK_DAMAGE).getValue() : 0;
