...
public class TablesBuyClicksProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (TheMiddleAgesModVariables.MapVariables.get(world).Wealth > 1) {
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(TheMiddleAgesModBlocks.MEDIEVAL_SPRUCE_TABLE.get()).copy();
				_setstack.setCount(1);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(TheMiddleAgesModBlocks.MEDIEVAL_OAK_TABLE.get()).copy();
				_setstack.setCount(1);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(TheMiddleAgesModBlocks.MEDIEVAL_DARK_OAK_TABLE.get()).copy();
				_setstack.setCount(1);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
