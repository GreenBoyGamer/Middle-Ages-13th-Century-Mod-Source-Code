...
public class EnemyArcherIdlePlaybackProcedure {
	public static boolean execute(Entity entity) {
		...
		return (entity instanceof EnemyArcherEntity _datEntI ? _datEntI.getEntityData().get(EnemyArcherEntity.DATA_actionstate) : 0) != 100
				&& (entity instanceof EnemyArcherEntity _datEntI ? _datEntI.getEntityData().get(EnemyArcherEntity.DATA_fightingState) : 0) == 0;
	}
}