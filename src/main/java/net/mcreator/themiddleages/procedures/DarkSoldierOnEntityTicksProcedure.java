...
public class DarkSoldierOnEntityTicksProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
			...
			if (!(!world.getEntitiesOfClass(Player.class, new AABB(Vec3.ZERO, Vec3.ZERO).move(new Vec3(x, y, z)).inflate(12 / 2d), e -> true).isEmpty())) {
				if ((entity instanceof DarkSoldierEntity _datEntL70 && _datEntL70.getEntityData().get(DarkSoldierEntity.DATA_notgonnarob)) == false) {
					...
					if ((entity instanceof DarkSoldierEntity _datEntI ? _datEntI.getEntityData().get(DarkSoldierEntity.DATA_actionstate) : 0) == 10) {
						entity.getPersistentData().putDouble("BuyingYes", (entity.getPersistentData().getDouble("BuyingYes") + 1));
						if (entity.getPersistentData().getDouble("BuyingYes") == 10) {
							if (world instanceof Level _level) {
								if (!_level.isClientSide()) {
						...
						if (entity.getPersistentData().getDouble("BuyingYes") >= 37) {
					...
					if (entity instanceof DarkSoldierEntity _datEntSetI)
						_datEntSetI.getEntityData().set(DarkSoldierEntity.DATA_actionstate, 0);
					entity.getPersistentData().putDouble("DonTrob", (entity.getPersistentData().getDouble("DonTrob") + 1));
					if (entity.getPersistentData().getDouble("DonTrob") >= 60) {
						if (entity instanceof DarkSoldierEntity _datEntSetL)
		...
		if ((entity instanceof DarkSoldierEntity _datEntI ? _datEntI.getEntityData().get(DarkSoldierEntity.DATA_Scared) : 0) == 1) {
			entity.getPersistentData().putDouble("scared", (entity.getPersistentData().getDouble("scared") + 1));
			if (entity.getPersistentData().getDouble("scared") == 25) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
			...
			} else if (entity.getPersistentData().getDouble("scared") == 60) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("ui.button.click")), SoundSource.NEUTRAL, 1, 1);
					} else {
			...
			} else if (entity.getPersistentData().getDouble("scared") > 250) {
				if (entity instanceof LivingEntity _entity)
					_entity.removeAllEffects();
				if (entity instanceof DarkSoldierEntity _datEntSetI)
