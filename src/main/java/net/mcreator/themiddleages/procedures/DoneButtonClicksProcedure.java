...
public class DoneButtonClicksProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!(parseDouble((entity instanceof Player _entity3 && _entity3.containerMenu instanceof TheMiddleAgesModMenus.MenuAccessor _menu3) ? _menu3.getMenuState(0, "TextField1", "") : "") > 1024
				&& parseDouble((entity instanceof Player _entity4 && _entity4.containerMenu instanceof TheMiddleAgesModMenus.MenuAccessor _menu4) ? _menu4.getMenuState(0, "TextField1", "") : "") < -1024
				&& parseDouble((entity instanceof Player _entity5 && _entity5.containerMenu instanceof TheMiddleAgesModMenus.MenuAccessor _menu5) ? _menu5.getMenuState(0, "TextField2", "") : "") > 1024
				&& parseDouble((entity instanceof Player _entity6 && _entity6.containerMenu instanceof TheMiddleAgesModMenus.MenuAccessor _menu6) ? _menu6.getMenuState(0, "TextField2", "") : "") < -1024)) {
