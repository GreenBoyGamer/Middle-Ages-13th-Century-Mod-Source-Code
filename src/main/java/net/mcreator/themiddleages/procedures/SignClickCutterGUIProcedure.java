...
public class SignClickCutterGUIProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof TheMiddleAgesModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(0).getItem() : ItemStack.EMPTY).getItem() == Blocks.OAK_LOG.asItem()) {
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.OAK_SIGN).copy();
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.SPRUCE_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.BIRCH_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.JUNGLE_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.ACACIA_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.PALE_OAK_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.DARK_OAK_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.MANGROVE_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(Blocks.CHERRY_SIGN).copy();
				_setstack.setCount(32);
				_player.getInventory().placeItemBackInInventory(_setstack);
			}
		}
