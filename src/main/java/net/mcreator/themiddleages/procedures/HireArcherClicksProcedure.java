...
public class HireArcherClicksProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (TheMiddleAgesModVariables.MapVariables.get(world).Wealth > 1) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = TheMiddleAgesModEntities.ARCHER.get().spawn(_level, BlockPos.containing(x, y, z), EntitySpawnReason.MOB_SUMMONED);
