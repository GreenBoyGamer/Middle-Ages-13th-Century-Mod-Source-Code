	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (entity instanceof LivingEntity _livEnt80 && _livEnt80.isSleeping()) {
				...
				if ((entity instanceof Civilian3Entity _datEntL86 && _datEntL86.getEntityData().get(Civilian3Entity.DATA_wasDoing)) == true) {
		...
		if ((entity instanceof Civilian3Entity _datEntI ? _datEntI.getEntityData().get(Civilian3Entity.DATA_giveThanks) : 0) == 1) {
			...
			} else if ((entity instanceof Civilian3Entity _datEntI ? _datEntI.getEntityData().get(Civilian3Entity.DATA_meet) : 0) == 3) {
		...
		if ((world instanceof Level _level205 ? _level205.getDefaultClockTime() : 0) == 50) {
			if (entity instanceof Civilian3Entity _datEntSetI)
				_datEntSetI.getEntityData().set(Civilian3Entity.DATA_hungry, 0);
		} else if ((world instanceof Level _level207 ? _level207.getDefaultClockTime() : 0) > 300 && (world instanceof Level _level208 ? _level208.getDefaultClockTime() : 0) < 1600) {
			if ((entity instanceof Civilian3Entity _datEntI ? _datEntI.getEntityData().get(Civilian3Entity.DATA_meet) : 0) == 0) {
				if ((entity instanceof Civilian3Entity _datEntI ? _datEntI.getEntityData().get(Civilian3Entity.DATA_GraveCarry) : 0) == 0) {
					if (entity instanceof Civilian3Entity _datEntSetI)
						_datEntSetI.getEntityData().set(Civilian3Entity.DATA_meet, Mth.nextInt(RandomSource.create(), 1, 3));
				}
			}
			if ((entity instanceof Civilian3Entity _datEntI ? _datEntI.getEntityData().get(Civilian3Entity.DATA_meet) : 0) == 1) {
		...
		if (entity instanceof LivingEntity _livEnt255 && _livEnt255.isSleeping()) {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 20, 255, false, false));
		}
