...
public class Modelwater_mill_gear<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon_r62 = wheel3.addOrReplaceChild("hexadecagon_r62", CubeListBuilder.create()
				.texOffs(92, 87).addBox(3.1153F, -4.5843F, -0.845F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r75 = wheel3.addOrReplaceChild("hexadecagon_r75",
				CubeListBuilder.create().texOffs(92, 84)
						.addBox(3.1153F, -4.5843F, -0.845F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(92, 72)
		...
		PartDefinition hexadecagon_r76 = wheel3.addOrReplaceChild("hexadecagon_r76", CubeListBuilder.create()
				.texOffs(92, 81).addBox(3.1153F, -4.5843F, -0.845F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition bone = wheel4.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 12)
				...
				.addBox(-7.3889F, 1.1111F, -2.1111F, 2.0F, 5.0F, 4.6667F, new CubeDeformation(0.0F)).texOffs(-10, 26)
				.addBox(-5.0556F, 0.1111F, 1.8889F, 13.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(4, 40)
				.addBox(-4.3889F, 1.1111F, -2.1111F, 12.0F, 5.0F, 4.6667F, new CubeDeformation(0.0F)).texOffs(8, 26)
				.addBox(-5.0556F, 0.1111F, -8.1111F, 13.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(4, 40)
				.addBox(-4.3889F, -6.8889F, -2.1111F, 12.0F, 5.0F, 4.6667F, new CubeDeformation(0.0F)).texOffs(0, 12)
				.addBox(-8.0556F, -7.8889F, -8.1111F, 3.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
				.addBox(-7.3889F, -6.8889F, -2.1111F, 2.0F, 5.0F, 4.6667F, new CubeDeformation(0.0F)).texOffs(18, 12)
				.addBox(-8.0556F, -7.8889F, 1.8889F, 3.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(8, 26)
				.addBox(-5.0556F, -7.8889F, -8.1111F, 13.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(-10, 26)
				.addBox(-5.0556F, -7.8889F, 1.8889F, 13.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
