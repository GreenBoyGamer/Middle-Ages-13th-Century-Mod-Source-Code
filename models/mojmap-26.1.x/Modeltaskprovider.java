...
public class Modeltaskprovider<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "taskprovider"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg2 = LeftLeg.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(22, 55)
				...
				.addBox(-1.9766F, 3.8333F, -2.2578F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
				.addBox(-2.0766F, 3.8333F, -2.2578F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
				.addBox(-2.022F, 2.5845F, -2.2578F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
				.addBox(-1.922F, 2.5845F, -2.2578F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
		...
		PartDefinition LeftLeg_r1 = LeftLeg2.addOrReplaceChild("LeftLeg_r1",
				CubeListBuilder.create().texOffs(67, 7)
						.addBox(1.1213F, -0.6075F, 1.6855F, 4.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).texOffs(67, 7)
						.addBox(1.0213F, -0.6075F, 1.6855F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(6, 18)
						.addBox(-4.5F, -3.75F, -1.25F, 9.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 47)
						.addBox(-4.25F, -8.3333F, 0.0156F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(27, 47)
						.addBox(0.25F, -8.3333F, 0.0156F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(25, 46)
						.addBox(-4.25F, -8.3333F, -4.0234F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(26, 46)
						.addBox(0.25F, -8.3333F, -4.0234F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(-4.25F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(75, 37)
						.addBox(-3.0F, -7.0F, 3.1F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(76, 45)
						.addBox(0.2719F, -7.0F, 3.1F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(68, 30)
						.addBox(-4.25F, -4.0F, -2.1F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 70)
						.addBox(3.2833F, -4.0F, -2.1F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(40, 43)
						.addBox(3.2833F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(-4.25F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(40, 43)
						.addBox(3.2833F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -13.0F, 0.0F));

		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.8579F, -3.3341F, 2.5702F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.5188F, -1.1635F, 2.8552F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.8346F, -1.355F, -1.7868F));

		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9277F, -3.7188F, -1.1324F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9424F, -3.6018F, -0.6242F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5845F, -1.2198F, 2.0702F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r4 = Head.addOrReplaceChild("Head_r4",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.7477F, -1.6524F, 2.2782F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r5 = Head.addOrReplaceChild("Head_r5",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4733F, -0.291F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r6 = Head.addOrReplaceChild("Head_r6",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.1272F, 1.1855F, 3.2923F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r7 = Head.addOrReplaceChild("Head_r7",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.2383F, 1.3091F, 1.3246F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r8 = Head.addOrReplaceChild("Head_r8",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.231F, 1.033F, 0.1132F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r9 = Head.addOrReplaceChild("Head_r9",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.639F, -1.0725F, 0.676F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r10 = Head.addOrReplaceChild("Head_r10",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.337F, -0.7668F, -1.6515F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r12 = Head.addOrReplaceChild("Head_r12",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.3487F, -1.0808F, -0.3844F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r14 = Head.addOrReplaceChild("Head_r14",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.2034F, 0.7476F, -1.0626F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r31 = Head.addOrReplaceChild("Head_r31",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(0.1272F, 1.1855F, 3.2923F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
						.addBox(0.589F, -0.9431F, 3.1402F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r32 = Head.addOrReplaceChild("Head_r32",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(0.2903F, 1.0091F, 2.7205F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
						.addBox(0.7522F, -1.0668F, 3.2156F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r33 = Head.addOrReplaceChild("Head_r33",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(0.2383F, 1.3091F, 1.3246F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
						.addBox(0.9179F, -1.3287F, 1.6059F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r34 = Head.addOrReplaceChild("Head_r34",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.7547F, -0.7088F, 1.5263F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r35 = Head.addOrReplaceChild("Head_r35",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(0.231F, 1.033F, 0.1132F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
						.addBox(0.6784F, -1.6519F, 0.4122F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r36 = Head.addOrReplaceChild("Head_r36",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5153F, -0.6582F, 0.2906F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.6609F, -1.3999F, -1.7444F));

		PartDefinition Head_r37 = Head.addOrReplaceChild("Head_r37", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.2034F, 0.7476F, -1.0627F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.714F, -1.8626F, -0.4108F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r38 = Head.addOrReplaceChild("Head_r38",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5509F, -0.6116F, -0.5576F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r45 = Head.addOrReplaceChild("Head_r45",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5095F, -0.425F, -1.7349F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r46 = Head.addOrReplaceChild("Head_r46",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.6726F, -2.0387F, -1.5898F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r47 = Head.addOrReplaceChild("Head_r47",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.262F, -0.638F, -2.843F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r48 = Head.addOrReplaceChild("Head_r48",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.4251F, -2.5749F, -2.5825F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r49 = Head.addOrReplaceChild("Head_r49",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.2077F, -0.01F, -4.0304F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r50 = Head.addOrReplaceChild("Head_r50",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.3709F, -2.333F, -3.9038F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r51 = Head.addOrReplaceChild("Head_r51",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5993F, -3.6124F, -4.1487F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r52 = Head.addOrReplaceChild("Head_r52",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.6536F, -4.0247F, -2.8703F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r53 = Head.addOrReplaceChild("Head_r53",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.9011F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.5818F, -1.3963F, -1.538F));

		PartDefinition Head_r54 = Head.addOrReplaceChild("Head_r54", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.7917F, -3.5649F, -0.2855F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.8355F, -1.3999F, -1.7444F));

		PartDefinition Head_r55 = Head.addOrReplaceChild("Head_r55", CubeListBuilder.create().texOffs(35, 50)
				.addBox(1.0331F, -3.4089F, 0.9409F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(1.1463F, -3.3358F, 1.4449F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r56 = Head.addOrReplaceChild("Head_r56",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.9761F, -3.7445F, 2.0693F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1051F, -4.4257F, 4.0252F, 1.8346F, -1.355F, -1.9177F));

		PartDefinition Head_r57 = Head.addOrReplaceChild("Head_r57", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.5188F, -1.1635F, 2.8552F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.8579F, -3.3341F, 2.5703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r59 = Head.addOrReplaceChild("Head_r59", CubeListBuilder.create().texOffs(35, 50)
				.addBox(1.1463F, -3.3357F, 1.4449F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(1.0331F, -3.4089F, 0.9409F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.7763F, -1.3135F, -1.6865F));

		PartDefinition Head_r60 = Head.addOrReplaceChild("Head_r60", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.7917F, -3.5649F, -0.2855F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3551F, -4.6757F, 4.1252F, 1.8355F, -1.3999F, -1.7444F));

		PartDefinition Head_r61 = Head.addOrReplaceChild("Head_r61", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9424F, -3.6018F, -0.6242F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9277F, -3.7188F, -1.1324F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r71 = Head.addOrReplaceChild("Head_r71", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.714F, -1.8626F, -0.4108F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.2034F, 0.7476F, -1.0626F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r73 = Head.addOrReplaceChild("Head_r73",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(0.6784F, -1.6519F, 0.4122F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(35, 50).addBox(0.231F, 1.033F, 0.1132F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r75 = Head.addOrReplaceChild("Head_r75", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9179F, -1.3287F, 1.6059F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.2383F, 1.3091F, 1.3246F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r77 = Head.addOrReplaceChild("Head_r77", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.7522F, -1.0668F, 3.2156F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.2903F, 1.0091F, 2.7205F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r78 = Head.addOrReplaceChild("Head_r78",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(0.589F, -0.9431F, 3.1402F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
						.addBox(0.1272F, 1.1855F, 3.2923F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r81 = Head.addOrReplaceChild("Head_r81", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9277F, -3.7188F, -1.1324F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9424F, -3.6018F, -0.6242F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.2949F, -4.6757F, -3.8748F, -2.1314F, 1.3324F, -2.3385F));

		PartDefinition Head_r82 = Head.addOrReplaceChild("Head_r82", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.8579F, -3.3341F, 2.5703F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.5188F, -1.1635F, 2.8552F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r84 = Head.addOrReplaceChild("Head_r84",
				CubeListBuilder.create().texOffs(35, 50).addBox(1.1463F, -3.3358F, 1.4449F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r86 = Head.addOrReplaceChild("Head_r86",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r88 = Head.addOrReplaceChild("Head_r88",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.9424F, -3.6018F, -0.6242F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r90 = Head.addOrReplaceChild("Head_r90",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.901F, -3.6226F, -1.816F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r93 = Head.addOrReplaceChild("Head_r93",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5993F, -3.6124F, -4.1487F, -1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r97 = Head.addOrReplaceChild("Head_r97", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.7917F, -3.5649F, -0.2855F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r98 = Head.addOrReplaceChild("Head_r98",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(1.0331F, -3.4089F, 0.941F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
						.addBox(1.1463F, -3.3357F, 1.4449F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r100 = Head.addOrReplaceChild("Head_r100",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.589F, -0.9431F, 3.1402F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r101 = Head.addOrReplaceChild("Head_r101",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.7522F, -1.0668F, 3.2156F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.958F, 0.0459F, -2.9306F));

		PartDefinition Head_r102 = Head.addOrReplaceChild("Head_r102", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.5187F, -1.1635F, 2.8552F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r106 = Head.addOrReplaceChild("Head_r106",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.262F, -0.638F, -2.843F, -1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r108 = Head.addOrReplaceChild("Head_r108",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.5F, -1.0F, -0.5F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r128 = Head.addOrReplaceChild("Head_r128",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.9179F, -1.3287F, 1.6058F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -2.9171F, 0.0294F, -2.886F));

		PartDefinition Head_r129 = Head.addOrReplaceChild("Head_r129", CubeListBuilder.create().texOffs(35, 50)
				.addBox(1.1463F, -3.3357F, 1.4449F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(1.033F, -3.4089F, 0.9409F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9551F, -4.6757F, 0.1252F, -3.048F, 0.0294F, -2.886F));

		PartDefinition Head_r130 = Head.addOrReplaceChild("Head_r130", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.7917F, -3.5649F, -0.2855F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r132 = Head.addOrReplaceChild("Head_r132",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.714F, -1.8626F, -0.4108F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r133 = Head.addOrReplaceChild("Head_r133",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.6784F, -1.6519F, 0.4122F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r147 = Head.addOrReplaceChild("Head_r147",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.8579F, -3.3341F, 2.5703F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r148 = Head.addOrReplaceChild("Head_r148",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.9277F, -3.7188F, -1.1324F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r149 = Head.addOrReplaceChild("Head_r149",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.6958F, -2.4872F, -0.55F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r150 = Head.addOrReplaceChild("Head_r150",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.4674F, -0.7477F, -0.4828F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r162 = Head.addOrReplaceChild("Head_r162",
				CubeListBuilder.create().texOffs(35, 50).addBox(0.3042F, 0.4732F, -0.291F, -1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition eyebrow = Head.addOrReplaceChild("eyebrow",
				CubeListBuilder.create().texOffs(105, 63)
						.addBox(-8.0568F, -27.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -27.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -26.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -26.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -25.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -25.5F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -25.5F, -3.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -26.5F, -3.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -27.5F, -3.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -25.5F, -3.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -26.5F, -3.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -27.5F, -3.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -29.25F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -28.25F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-8.0568F, -27.25F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -29.25F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -28.25F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -27.25F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -26.25F, -1.35F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -27.25F, -1.35F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -25.5F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-2.3068F, -24.5F, -2.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-5.3068F, -25.0F, -4.35F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-5.3068F, -24.0F, -4.6F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-6.3068F, -25.0F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-3.3068F, -25.0F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
						.addBox(-5.3068F, -25.75F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.8333F, 24.6F, -0.0258F));

		PartDefinition Head_r200 = eyebrow.addOrReplaceChild("Head_r200",
				CubeListBuilder.create().texOffs(105, 63).addBox(-2.0F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition frown_L = smile_frown.addOrReplaceChild("frown_L",
				CubeListBuilder.create().texOffs(52, 37).addBox(-0.0273F, -1.2016F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition frown_R = smile_frown.addOrReplaceChild("frown_R",
				CubeListBuilder.create().texOffs(52, 37).addBox(-1.0017F, -1.193F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(3, 27)
						.addBox(-1.5F, 5.0F, -2.5F, 3.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						.addBox(-0.5F, 5.0117F, -2.557F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						.addBox(-0.5F, 6.9117F, -2.557F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						...
						.addBox(-4.6F, 9.0F, -2.6F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(1.5F, -0.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(68, 22)
						.addBox(-4.5F, -0.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
						.addBox(-4.05F, 8.5F, -3.4F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
						.addBox(-4.15F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
						.addBox(-2.95F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
						.addBox(-3.55F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(92, 7)
						.addBox(-1.0F, 9.1617F, -2.6599F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 7)
						.addBox(-1.0F, 8.7617F, -2.657F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 7)
						.addBox(0.0F, 8.7617F, -2.657F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 7)
						.addBox(0.0F, 9.1617F, -2.6599F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -13.0F, 0.0F));

		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(66, 1).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm = Waist.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(50, 62)
		...
		PartDefinition RightArm = Waist.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(50, 62).addBox(
		...
		PartDefinition RightLeg2 = RightLeg.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(52, 26)
				...
				.addBox(-1.9766F, 4.0F, -2.2578F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-2.0766F, 4.0F, -2.2578F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-2.1311F, 2.7512F, -2.2578F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-2.0311F, 2.7512F, -2.2578F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
				.addBox(-2.1117F, 5.0F, -4.3711F, 1.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0117F, 5.0F, -0.6289F));

		PartDefinition RightLeg_r1 = RightLeg2.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(65, 54)
				.addBox(-3.5242F, -0.6741F, 1.6855F, 4.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).texOffs(65, 54)
				.addBox(-3.6242F, -0.6741F, 1.6855F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)),
