...
public class Modelcivilian5<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "civilian5"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition eyebrow = Head.addOrReplaceChild("eyebrow",
				CubeListBuilder.create().texOffs(105, 63)
						...
						.addBox(-5.3068F, -25.0F, -4.1F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 63)
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27)
						...
						.addBox(-4.6F, 9.0F, -2.6F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(70, 22)
						.addBox(-2.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(2, 67)
						.addBox(3.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(1.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(68, 22)
						.addBox(-4.5F, -0.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
		...
		PartDefinition hammer = LeftArm2.addOrReplaceChild("hammer",
				CubeListBuilder.create().texOffs(112, 65)
						.addBox(-0.5F, -0.5F, 0.5833F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 65)
						.addBox(-0.5F, -0.5F, -1.4167F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 2)
						.addBox(-0.5F, -0.5F, 2.5833F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.1167F, 4.5833F, -3.9F));

		PartDefinition Body_r8 = hammer.addOrReplaceChild("Body_r8",
				CubeListBuilder.create().texOffs(117, 79).addBox(-1.5F, -1.5F, -1.0F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5117F, 0.6667F, -1.1068F, 1.5708F, 0.0F, 0.0F));

		PartDefinition Body_r9 = hammer.addOrReplaceChild("Body_r9",
				CubeListBuilder.create().texOffs(116, 78).addBox(-1.5F, -1.5F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -0.6667F, -1.0755F, 1.5708F, 0.0F, 0.0F));

		PartDefinition Body_r10 = hammer.addOrReplaceChild("Body_r10",
				CubeListBuilder.create().texOffs(116, 78).addBox(-1.5F, -1.5F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
