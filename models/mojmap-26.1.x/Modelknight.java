...
public class Modelknight<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 38)
				.addBox(-0.3976F, -8.0938F, -4.4593F, 1.0F, 3.0F, 8.5F, new CubeDeformation(0.0F)).texOffs(98, 100)
		...
		PartDefinition Body_r5 = Body.addOrReplaceChild("Body_r5",
				CubeListBuilder.create().texOffs(90, 8).addBox(-1.0F, -1.25F, -2.0F, 2.0F, 5.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r6 = Body.addOrReplaceChild("Body_r6",
				CubeListBuilder.create().texOffs(90, 8).addBox(-1.8839F, -1.8839F, -2.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r7 = Body.addOrReplaceChild("Body_r7",
				CubeListBuilder.create().texOffs(90, 8).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Right_Arm2 = RightArm.addOrReplaceChild("Right_Arm2", CubeListBuilder.create().texOffs(0, 87)
				.addBox(-2.035F, 0.0031F, -2.043F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 4.0F, 0.0F));

		PartDefinition RightArm2 = Right_Arm2.addOrReplaceChild("RightArm2", CubeListBuilder.create().texOffs(91, 102)
				.addBox(-0.4942F, -1.0847F, -14.8391F, 1.0F, 2.1F, 17.0F, new CubeDeformation(0.0F)).texOffs(0, 97)
		...
		PartDefinition RightArm_r3 = RightArm2.addOrReplaceChild("RightArm_r3",
				CubeListBuilder.create().texOffs(-3, 0).mirror()
						...
						.texOffs(-3, 0).mirror().addBox(0.5F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(-3, 0).mirror()
						.addBox(0.25F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.7529F, 0.0141F, 9.6161F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition LeftArm = Right_Arm4.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(98, 92)
				.addBox(-0.5087F, -0.6635F, 17.4878F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(88, 105)
				.mirror().addBox(-0.5174F, -1.2623F, -0.2675F, 1.0F, 2.1F, 17.0F, new CubeDeformation(0.0F))
				.mirror(false), PartPose.offset(-1.4079F, 4.4135F, -20.4878F));

		PartDefinition LeftArm_r3 = LeftArm.addOrReplaceChild(
				"LeftArm_r3", CubeListBuilder.create().texOffs(42, 17).addBox(-0.5F, -1.05F, -0.793F, 1.0F, 1.4164F,
		...
		PartDefinition LeftArm_r4 = LeftArm.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(-3, 0).mirror()
						...
						.texOffs(-3, 0).mirror().addBox(0.5F, -1.0F, 1.0F, 1.0F, 2.0F, -2.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-0.7587F, -0.1635F, 24.1878F, -0.7854F, 0.0F, 0.0F));
