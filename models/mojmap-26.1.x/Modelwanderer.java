	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11)
						...
						.addBox(-4.25F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(76, 45)
		...
		PartDefinition Head_r132 = Head.addOrReplaceChild("Head_r132",
				CubeListBuilder.create().texOffs(58, 24).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition mouth = Head.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(52, 37).addBox(-1.0F,
				0.1667F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition frown_L = smile_frown.addOrReplaceChild("frown_L",
				CubeListBuilder.create().texOffs(52, 37).addBox(-0.1716F, -0.5507F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition frown_R = smile_frown.addOrReplaceChild("frown_R",
				CubeListBuilder.create().texOffs(52, 37).addBox(-0.8574F, -0.5421F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27)
						...
						.addBox(-4.05F, 8.5F, -3.4F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(114, 5)
						.addBox(0.95F, 7.4167F, -3.4F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
		...
		PartDefinition LeftArm = Waist.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(50, 62)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(50, 62)
						.addBox(-1.0F, 2.5F, -2.25F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(50, 62)
						.addBox(-1.2F, 2.5F, -1.75F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(53, 65)
						.addBox(-1.2F, 2.5F, -2.25F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 62)
						.addBox(-0.6F, 2.5F, -2.25F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(50, 62)
						.addBox(-0.8F, 2.5F, -1.75F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.5F, -11.0F, 0.0F));

		PartDefinition Body_r10 = LeftArm.addOrReplaceChild("Body_r10",
		...
		PartDefinition Body_r11 = LeftArm.addOrReplaceChild("Body_r11",
		...
		PartDefinition LeftArm2 = LeftArm
				.addOrReplaceChild("LeftArm2",
						CubeListBuilder.create().texOffs(58, 37).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r12 = RightArm.addOrReplaceChild("Body_r12",
				CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.1667F, -0.8359F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition Body_r13 = RightArm.addOrReplaceChild("Body_r13",
				CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
