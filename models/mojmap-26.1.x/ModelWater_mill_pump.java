...
public class ModelWater_mill_pump<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "water_mill_pump"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon = partdefinition.addOrReplaceChild("hexadecagon", CubeListBuilder.create(),
				PartPose.offset(0.0008F, 16.3659F, -0.3482F));

		PartDefinition hexadecagon_r1 = hexadecagon.addOrReplaceChild("hexadecagon_r1", CubeListBuilder.create()
				.texOffs(-8, 7).addBox(-9.0833F, -2.25F, -2.1826F, 11.0F, 1.0F, 4.3652F, new CubeDeformation(0.0F))
				.texOffs(-8, 7).addBox(-9.0833F, 1.25F, -2.1826F, 11.0F, 1.0F, 4.3652F, new CubeDeformation(0.0F))
				.texOffs(-4, 10).addBox(-9.0833F, -1.25F, -2.1826F, 11.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(-4, 10).addBox(-9.0833F, -1.75F, 1.1826F, 11.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-12.0F, -16.0F, 0.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 0)
				.mirror().addBox(-12.0F, -16.0F, 10.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(-1, -1).mirror()
				.addBox(-11.3333F, -14.6667F, 6.0F, 6.6667F, 2.0F, 4.6667F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 0).mirror().addBox(-12.0F, -6.0F, 0.0F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(-1, -1).mirror()
				.addBox(-11.3333F, -5.0F, 6.0F, 6.6667F, 3.0F, 4.6667F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 0).mirror().addBox(-12.0F, -6.0F, 10.0F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false), PartPose.offset(8.0F, 24.0F, -8.0F));

		PartDefinition hexadecagon_r10 = bone.addOrReplaceChild("hexadecagon_r10", CubeListBuilder.create()
				.texOffs(-17, 7).addBox(-18.0833F, -2.25F, -2.1826F, 8.0F, 1.0F, 4.3652F, new CubeDeformation(0.0F))
				.texOffs(-13, 10).addBox(-18.0833F, -1.25F, -2.1826F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(-17, 7).addBox(-18.0833F, 1.25F, -2.1826F, 8.0F, 1.0F, 4.3652F, new CubeDeformation(0.0F))
				.texOffs(-13, 10).addBox(-18.0833F, -1.75F, 1.1826F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.9333F, -8.05F, -12.9167F, 0.0F, 1.5708F, 0.7854F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(4, 2).mirror()
						.addBox(-2.0F, -30.0F, -2.0F, 4.0F, 60.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
