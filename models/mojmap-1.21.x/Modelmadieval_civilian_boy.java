...
public class Modelmadieval_civilian_boy<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "madieval_civilian_boy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg2 = LeftLeg.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(22, 55)
				...
				.addBox(-1.9102F, 3.8333F, -2.2578F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
				.addBox(-1.9117F, 4.8333F, -4.3711F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
				.addBox(-2.1117F, 4.8333F, -4.3711F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
				.addBox(-2.0117F, 4.8333F, -4.3711F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
				.addBox(-2.1055F, 3.8333F, -2.2578F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
				.addBox(-1.9488F, 2.8437F, -2.2578F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 0)
		...
		PartDefinition LeftLeg_r1 = LeftLeg2.addOrReplaceChild("LeftLeg_r1",
				CubeListBuilder.create().texOffs(63, 3)
						.addBox(0.3089F, -2.5357F, -3.1946F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(63, 3)
						.addBox(0.5042F, -2.5357F, -3.1946F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(7, 18)
						.addBox(-4.5F, -3.75F, -1.75F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(7, 18)
						.addBox(-3.5F, -3.75F, -1.75F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(-4.25F, -8.0F, -4.1F, 1.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(-4.45F, -8.0F, -4.1F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(-4.45F, -8.3F, -4.1F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(3.45F, -8.0F, -4.1F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(3.45F, -8.3F, -4.1F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(74, 37)
						...
						.addBox(-3.7167F, -7.7F, -4.1F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(33, 43)
						.addBox(-3.7167F, -8.3F, -4.3F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(33, 43)
						.addBox(-4.2362F, -8.3F, -4.1F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-5.0F, -7.2F, -4.5F, 10.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(13, 8).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.7F, 4.25F, 0.0F, 0.0F, 0.7854F));

		PartDefinition Head_r4 = Head.addOrReplaceChild("Head_r4", CubeListBuilder.create().texOffs(44, 47)
				.addBox(-2.2422F, -1.1759F, -1.0245F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(-1.0753F, -3.715F, -0.4375F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.4244F, -4.5446F, 0.1734F, -1.4281F, 1.2226F, -1.5609F));

		PartDefinition Head_r5 = Head.addOrReplaceChild("Head_r5", CubeListBuilder.create().texOffs(44, 47)
				.addBox(-0.9431F, -0.7054F, -1.0923F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(0.2238F, -3.2446F, -0.5053F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.4244F, -4.5446F, 0.1734F, -1.4748F, 1.3529F, -1.6058F));

		PartDefinition Head_r6 = Head.addOrReplaceChild("Head_r6", CubeListBuilder.create().texOffs(44, 47)
				.addBox(0.3594F, -0.4242F, -1.1466F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(1.5263F, -2.9634F, -0.5596F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(3.4142F, -2.5473F, -0.5996F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.4244F, -4.5446F, 0.1734F, -1.4748F, 1.3529F, -1.5621F));

		PartDefinition Head_r7 = Head.addOrReplaceChild("Head_r7", CubeListBuilder.create().texOffs(44, 47)
				.addBox(3.0064F, -2.2143F, -0.9553F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
		...
		PartDefinition Head_r8 = Head.addOrReplaceChild("Head_r8",
				CubeListBuilder.create().texOffs(44, 47).addBox(2.0979F, -1.9485F, -0.9897F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r9 = Head.addOrReplaceChild("Head_r9",
				CubeListBuilder.create().texOffs(44, 47).addBox(-0.2566F, -2.3469F, -0.861F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r10 = Head.addOrReplaceChild("Head_r10",
				CubeListBuilder.create().texOffs(44, 47).addBox(-1.6177F, -2.5847F, -0.7931F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.4244F, -4.5446F, 0.1734F, -1.2918F, 1.3937F, -1.4202F));

		PartDefinition Head_r11 = Head.addOrReplaceChild("Head_r11", CubeListBuilder.create().texOffs(44, 47)
				.addBox(-2.9725F, -2.3451F, -0.8304F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(-4.0789F, -2.2931F, -0.8293F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r12 = Head.addOrReplaceChild("Head_r12",
				CubeListBuilder.create().texOffs(32, 70).addBox(-0.6549F, 0.5446F, -2.2734F, 1.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r13 = Head.addOrReplaceChild("Head_r13",
				CubeListBuilder.create().texOffs(44, 47).addBox(-0.9649F, 0.3563F, -1.448F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r16 = Head.addOrReplaceChild("Head_r16",
				CubeListBuilder.create().texOffs(44, 47).addBox(0.3666F, 0.4071F, -1.5023F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.4244F, -4.8337F, 0.1734F, -1.1158F, 1.5236F, -1.2014F));

		PartDefinition Head_r17 = Head.addOrReplaceChild("Head_r17", CubeListBuilder.create().texOffs(44, 47)
				.addBox(-2.4511F, -3.7144F, -0.4747F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(-3.7149F, -3.8991F, -0.4684F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r18 = Head.addOrReplaceChild("Head_r18",
				CubeListBuilder.create().texOffs(44, 47).addBox(2.4733F, -2.4434F, -0.634F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r19 = Head.addOrReplaceChild("Head_r19",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(1.3887F, 0.7352F, -1.6746F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(2.097F, -1.968F, -1.0876F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r20 = Head.addOrReplaceChild("Head_r20",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(1.3089F, 0.0765F, -1.3189F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(2.4758F, -2.4627F, -0.7319F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r21 = Head.addOrReplaceChild("Head_r21",
				CubeListBuilder.create().texOffs(44, 47).addBox(-0.5F, -1.5F, -1.0F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.621F, -3.6705F, 3.3955F, -2.0035F, -1.5214F, 2.1754F));

		PartDefinition Head_r22 = Head.addOrReplaceChild("Head_r22", CubeListBuilder.create().texOffs(44, 47)
				.addBox(2.2969F, 0.4694F, -1.6402F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(0.3655F, 0.3875F, -1.6001F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(3.0052F, -2.2338F, -1.0532F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(1.0737F, -2.3157F, -1.0131F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r23 = Head.addOrReplaceChild("Head_r23",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.94F, -0.729F, -1.1893F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(0.227F, -3.2682F, -0.6022F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r24 = Head.addOrReplaceChild("Head_r24",
				CubeListBuilder.create().texOffs(44, 47).addBox(-2.2388F, -1.1994F, -1.1214F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r26 = Head.addOrReplaceChild("Head_r26", CubeListBuilder.create().texOffs(44, 47)
				.addBox(-3.7118F, -3.9227F, -0.5654F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(-2.4481F, -3.738F, -0.5717F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r27 = Head.addOrReplaceChild("Head_r27",
				CubeListBuilder.create().texOffs(44, 47).addBox(-1.6184F, -2.6084F, -0.8901F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r28 = Head.addOrReplaceChild("Head_r28",
				CubeListBuilder.create().texOffs(44, 47).addBox(-0.2576F, -2.3707F, -0.9579F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.6949F, -4.5423F, 0.1734F, 2.0257F, -1.5236F, -1.8093F));

		PartDefinition Head_r29 = Head.addOrReplaceChild("Head_r29", CubeListBuilder.create().texOffs(44, 47)
				.addBox(0.3616F, -0.4436F, -1.2445F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
				.addBox(1.5285F, -2.9828F, -0.6574F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r31 = Head.addOrReplaceChild("Head_r31",
				CubeListBuilder.create().texOffs(44, 44).addBox(-0.0723F, -3.3874F, -0.2453F, 4.0F, 6.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r32 = Head.addOrReplaceChild("Head_r32",
				CubeListBuilder.create().texOffs(44, 47).addBox(-1.0719F, -3.7385F, -0.5344F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r33 = Head.addOrReplaceChild("Head_r33",
				CubeListBuilder.create().texOffs(44, 47).addBox(-2.9736F, -2.3689F, -0.9273F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r34 = Head.addOrReplaceChild("Head_r34",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(0.252F, -3.246F, -0.5287F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
		...
		PartDefinition Head_r35 = Head.addOrReplaceChild("Head_r35",
				CubeListBuilder.create().texOffs(44, 47)
						...
						.texOffs(44, 47).addBox(-0.9374F, 0.35F, -1.4714F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r36 = Head.addOrReplaceChild("Head_r36",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.9149F, -0.7068F, -1.1157F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(44, 47).addBox(0.252F, -3.246F, -0.5287F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r37 = Head.addOrReplaceChild("Head_r37",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.9374F, 0.35F, -1.4714F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(-0.2291F, -2.3532F, -0.8843F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r39 = Head.addOrReplaceChild("Head_r39",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.2291F, -2.3532F, -0.8843F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(44, 47).addBox(-0.9374F, 0.35F, -1.4714F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r40 = Head.addOrReplaceChild("Head_r40",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.9149F, -0.7068F, -1.1157F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(44, 47).addBox(0.252F, -3.246F, -0.5286F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r41 = Head.addOrReplaceChild("Head_r41",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.9374F, 0.35F, -1.4713F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(-0.2291F, -2.3532F, -0.8843F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r42 = Head.addOrReplaceChild("Head_r42",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(0.252F, -3.246F, -0.5286F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(-0.9149F, -0.7068F, -1.1157F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r43 = Head.addOrReplaceChild("Head_r43",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.2291F, -2.3532F, -0.8843F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(44, 47).addBox(-0.9374F, 0.35F, -1.4713F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r45 = Head.addOrReplaceChild("Head_r45",
				CubeListBuilder.create().texOffs(44, 47)
						.addBox(-0.9374F, 0.35F, -1.4713F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 47)
						.addBox(-0.2291F, -2.3532F, -0.8843F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r46 = Head.addOrReplaceChild("Head_r46",
				CubeListBuilder.create().texOffs(44, 47).addBox(0.0F, -1.5F, -1.0F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r51 = Head.addOrReplaceChild("Head_r51",
				CubeListBuilder.create().texOffs(44, 48).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27)
						...
						.addBox(-1.5F, 2.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(38, 9)
						...
						.addBox(-0.5F, 2.0117F, -2.557F, 1.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(76, 14)
						.addBox(-1.0F, 8.7617F, -2.657F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(76, 14)
						.addBox(0.0F, 8.7617F, -2.657F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(76, 14)
						.addBox(-1.0F, 9.1617F, -2.6599F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(76, 14)
						.addBox(0.0F, 9.1617F, -2.6599F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						...
						.addBox(-3.3F, 9.0F, -2.6F, 6.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(46, 50)
						.addBox(-4.05F, 8.5F, -3.4F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 50)
						.addBox(-4.15F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 50)
						.addBox(-2.95F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 50)
						.addBox(-3.55F, 8.7F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 72)
						.addBox(-4.6F, 9.0F, -2.6F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -13.0F, 0.0F));

		PartDefinition Body_r1 = Body
				.addOrReplaceChild("Body_r1",
						CubeListBuilder.create().texOffs(0, 67).addBox(-4.0F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(5.5F, 1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition Body_r2 = Body.addOrReplaceChild("Body_r2",
				CubeListBuilder.create().texOffs(68, 22).addBox(0.3333F, -1.5F, -2.5006F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.8333F, 1.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition Body_r3 = Body.addOrReplaceChild("Body_r3",
				CubeListBuilder.create().texOffs(46, 50).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r8 = Body.addOrReplaceChild("Body_r8",
				CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -3.0F, -2.5F, 4.0F, 6.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r10 = Body.addOrReplaceChild("Body_r10",
				CubeListBuilder.create().texOffs(0, 27).addBox(-4.5F, -5.0F, -2.5006F, 4.0F, 10.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.8672F, 7.2539F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition Body_r11 = Body
				.addOrReplaceChild("Body_r11",
						CubeListBuilder.create().texOffs(0, 27).addBox(-4.5F, -5.0F, -2.5006F, 4.0F, 10.0F, 5.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm = Waist.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(50, 62)
						.addBox(-1.1F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(2, 67)
		...
		PartDefinition Body_r12 = LeftArm.addOrReplaceChild("Body_r12",
				CubeListBuilder.create().texOffs(2, 67)
						.addBox(-0.3333F, -1.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(-3.3333F, -1.5F, -2.5006F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.1667F, -1.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition Body_r13 = LeftArm.addOrReplaceChild("Body_r13",
				CubeListBuilder.create().texOffs(0, 67).addBox(-3.3333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm2 = LeftArm.addOrReplaceChild("LeftArm2", CubeListBuilder.create().texOffs(58, 37).addBox(
				-2.1F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 4.5F, 0.0F));
		...
		PartDefinition RightArm = Waist.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(50, 62).addBox(
				-0.6F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(5.5F, -11.0F, 0.0F));

		PartDefinition Body_r14 = RightArm
				.addOrReplaceChild("Body_r14",
						CubeListBuilder.create().texOffs(2, 67).addBox(2.0F, -1.5F, -2.5006F, 1.0F, 3.0F, 5.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.8F, -1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition Body_r15 = RightArm.addOrReplaceChild("Body_r15",
				CubeListBuilder.create().texOffs(2, 67)
						.addBox(2.0F, -1.5F, -2.5F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(-1.0F, -1.5F, -2.5006F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition RightArm2 = RightArm.addOrReplaceChild("RightArm2", CubeListBuilder.create().texOffs(58, 37)
				.addBox(-1.6F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg2 = RightLeg.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(52, 26)
				...
				.addBox(-2.0077F, 5.0F, -4.3711F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-2.0077F, 4.0F, -2.2578F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-2.1077F, 4.0F, -2.2578F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-1.9367F, 2.9916F, -2.2578F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 47)
				.addBox(-2.1047F, 2.9916F, -2.2578F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
				.addBox(-2.1077F, 5.0F, -4.3711F, 4.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0117F, 5.0F, -0.6289F));

		PartDefinition RightLeg_r1 = RightLeg2.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(61, 50)
				.addBox(-4.4042F, -2.5354F, -3.1946F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(61, 50)
				.addBox(-4.5042F, -2.5354F, -3.1946F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
