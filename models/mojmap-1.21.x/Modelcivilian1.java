...
public class Modelcivilian1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "civilian1"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11)
						...
						.addBox(-0.9F, -1.4F, -4.1F, 2.0F, -1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(22, 43)
						.addBox(-4.25F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(74, 37)
						.addBox(-4.25F, -7.0F, 3.1F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(76, 45)
						...
						.addBox(3.2833F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-5.0F, -8.0F, -4.5F, 10.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(32, 11)
						.addBox(-3.5F, -10.0F, -3.5F, 7.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(50, 55)
		...
		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.5F, -0.5F, 1.0F, -1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leave = carrot.addOrReplaceChild("leave", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4165F, -1.1111F));
		...
		PartDefinition leave2 = carrot.addOrReplaceChild("leave2", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4165F, 0.2222F));
		...
		PartDefinition leave3 = carrot.addOrReplaceChild("leave3", CubeListBuilder.create(),
				PartPose.offset(0.4354F, -1.4165F, 0.2222F));
