...
public class Modelmadieval_farmer_civilian<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "madieval_farmer_civilian"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 11)
						...
						.addBox(-4.25F, -7.0F, -4.1F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(74, 37)
						.addBox(-4.0F, -7.0F, 3.1F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(76, 45)
						...
						.addBox(3.2833F, -8.3F, -4.1F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(-4.75F, -6.4167F, -4.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(-0.25F, -6.4167F, -4.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(-4.75F, -6.4167F, -0.25F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(-0.25F, -6.4167F, -0.25F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -13.0F, 0.0F));

		PartDefinition Body_r1 = Head.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(-1, 37).addBox(-2.5F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r2 = Head.addOrReplaceChild("Body_r2",
				CubeListBuilder.create().texOffs(0, 37).addBox(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r3 = Head.addOrReplaceChild("Body_r3",
				CubeListBuilder.create().texOffs(2, 36).addBox(-0.5F, -0.5F, -1.5F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r11 = Head.addOrReplaceChild("Head_r11", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r28 = Head.addOrReplaceChild("Head_r28", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r29 = Head.addOrReplaceChild("Head_r29", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r31 = Head.addOrReplaceChild("Head_r31", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r33 = Head.addOrReplaceChild("Head_r33", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r34 = Head.addOrReplaceChild("Head_r34", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r35 = Head.addOrReplaceChild("Head_r35", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r45 = Head.addOrReplaceChild("Head_r45", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r49 = Head.addOrReplaceChild("Head_r49", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r51 = Head.addOrReplaceChild("Head_r51", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r56 = Head.addOrReplaceChild("Head_r56", CubeListBuilder.create().texOffs(35, 50)
		...
		PartDefinition Head_r67 = Head.addOrReplaceChild("Head_r67", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.7917F, -3.5649F, -0.2855F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r72 = Head.addOrReplaceChild("Head_r72", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9806F, -3.2862F, 3.0751F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
		...
		PartDefinition Head_r78 = Head.addOrReplaceChild("Head_r78", CubeListBuilder.create().texOffs(35, 50)
				.addBox(1.1463F, -3.3357F, 1.4449F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
		...
		PartDefinition Head_r79 = Head.addOrReplaceChild("Head_r79", CubeListBuilder.create().texOffs(35, 50)
				.addBox(0.9068F, -3.5005F, 0.2193F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 50)
				.addBox(0.7917F, -3.5649F, -0.2855F, -1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r133 = eyebrow.addOrReplaceChild("Head_r133",
		...
		PartDefinition Body = Waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 27)
						...
						.addBox(-1.5F, 2.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						.addBox(-0.5F, 2.0117F, -2.557F, 1.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 37)
						.addBox(-0.5F, 6.9117F, -2.557F, 1.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						...
						.addBox(1.5F, -0.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(66, 1)
		...
		PartDefinition Body_r13 = LeftArm.addOrReplaceChild("Body_r13",
				CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0081F, -0.8359F, 0.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition Body_r14 = LeftArm.addOrReplaceChild("Body_r14",
				CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition carrot = LeftArm2.addOrReplaceChild("carrot", CubeListBuilder.create().texOffs(30, 103)
				.addBox(-0.4852F, 2.146F, -0.2778F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5396F, 0.6939F, -0.0556F));

		PartDefinition LeftArm_r1 = carrot.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3061F, 0.3061F, 0.2222F, 0.0F, 0.0F, 0.1309F));

		PartDefinition LeftArm_r2 = carrot.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2938F, 0.3061F, 0.2222F, 0.0F, 0.0F, -0.1309F));

		PartDefinition leave = carrot.addOrReplaceChild("leave", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4166F, -1.1111F));

		PartDefinition LeftArm_r3 = leave
				.addOrReplaceChild("LeftArm_r3",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leave2 = carrot.addOrReplaceChild("leave2", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4166F, 0.2222F));

		PartDefinition LeftArm_r4 = leave2
				.addOrReplaceChild("LeftArm_r4",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leave3 = carrot.addOrReplaceChild("leave3", CubeListBuilder.create(),
				PartPose.offset(0.4354F, -1.4166F, 0.2222F));

		PartDefinition LeftArm_r5 = leave3
				.addOrReplaceChild("LeftArm_r5",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition carrot2 = LeftArm2.addOrReplaceChild("carrot2", CubeListBuilder.create().texOffs(30, 103)
				.addBox(-0.4852F, 2.146F, -0.2778F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5396F, 0.6939F, -0.0556F));

		PartDefinition LeftArm_r6 = carrot2.addOrReplaceChild("LeftArm_r6",
				CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3061F, 0.3061F, 0.2222F, 0.0F, 0.0F, 0.1309F));

		PartDefinition LeftArm_r7 = carrot2.addOrReplaceChild("LeftArm_r7",
				CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2938F, 0.3061F, 0.2222F, 0.0F, 0.0F, -0.1309F));

		PartDefinition leave4 = carrot2.addOrReplaceChild("leave4", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4166F, -1.1111F));

		PartDefinition LeftArm_r8 = leave4
				.addOrReplaceChild("LeftArm_r8",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leave5 = carrot2.addOrReplaceChild("leave5", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4166F, 0.2222F));

		PartDefinition LeftArm_r9 = leave5
				.addOrReplaceChild("LeftArm_r9",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leave6 = carrot2.addOrReplaceChild("leave6", CubeListBuilder.create(),
				PartPose.offset(0.4354F, -1.4166F, 0.2222F));

		PartDefinition LeftArm_r10 = leave6
				.addOrReplaceChild("LeftArm_r10",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition carrot3 = LeftArm2.addOrReplaceChild("carrot3", CubeListBuilder.create().texOffs(30, 103)
				.addBox(-0.4852F, 2.146F, -0.2778F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5396F, 0.6939F, -0.0556F));

		PartDefinition LeftArm_r11 = carrot3.addOrReplaceChild("LeftArm_r11",
				CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3061F, 0.3061F, 0.2222F, 0.0F, 0.0F, 0.1309F));

		PartDefinition LeftArm_r12 = carrot3.addOrReplaceChild("LeftArm_r12",
				CubeListBuilder.create().texOffs(30, 103).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2938F, 0.3061F, 0.2222F, 0.0F, 0.0F, -0.1309F));

		PartDefinition leave7 = carrot3.addOrReplaceChild("leave7", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4166F, -1.1111F));

		PartDefinition LeftArm_r13 = leave7
				.addOrReplaceChild("LeftArm_r13",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leave8 = carrot3.addOrReplaceChild("leave8", CubeListBuilder.create(),
				PartPose.offset(-0.2313F, -1.4166F, 0.2222F));

		PartDefinition LeftArm_r14 = leave8
				.addOrReplaceChild("LeftArm_r14",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition leave9 = carrot3.addOrReplaceChild("leave9", CubeListBuilder.create(),
				PartPose.offset(0.4354F, -1.4166F, 0.2222F));

		PartDefinition LeftArm_r15 = leave9
				.addOrReplaceChild("LeftArm_r15",
						CubeListBuilder.create().texOffs(60, 113).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		...
		PartDefinition Body_r15 = RightArm.addOrReplaceChild("Body_r15",
				CubeListBuilder.create().texOffs(0, 67).addBox(-0.8333F, -1.5F, -2.5009F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.1667F, -0.8359F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition Body_r16 = RightArm.addOrReplaceChild("Body_r16",
				CubeListBuilder.create().texOffs(0, 67).addBox(-2.1667F, -1.5F, -2.5F, 3.0F, 3.0F, 5.0F,
						new CubeDeformation(0.0F)),
