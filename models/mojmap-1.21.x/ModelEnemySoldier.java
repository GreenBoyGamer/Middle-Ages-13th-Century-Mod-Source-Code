...
public class ModelEnemySoldier<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "enemysoldier"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_r2 = body.addOrReplaceChild("body_r2",
				...
				PartPose.offsetAndRotation(-0.0589F, -0.0575F, 0.2297F, -3.1416F, 0.0F, 3.1416F));
		...
		PartDefinition body_r9 = body.addOrReplaceChild("body_r9",
				CubeListBuilder.create().texOffs(33, 16).addBox(1.0F, 1.0F, 1.0F, 1.0F, 1.0F, -1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.2744F, -0.3574F, -0.15F, 0.0F, 0.0F, -0.1745F));
		...
		PartDefinition head_r9 = head.addOrReplaceChild("head_r9",
				CubeListBuilder.create().texOffs(5, 120).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition down_side = right_arm.addOrReplaceChild("down_side", CubeListBuilder.create().texOffs(80, 70)
		...
		PartDefinition sword = down_side.addOrReplaceChild("sword",
				CubeListBuilder.create().texOffs(103, 51)
						.addBox(-0.5F, -0.9527F, 13.8733F, 1.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(69, 26)
						.addBox(-0.5F, -1.9527F, 12.8733F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
		...
		PartDefinition sword_r1 = sword
				.addOrReplaceChild("sword_r1",
						CubeListBuilder.create().texOffs(33, 16).addBox(-0.5F, -1.0F, 1.0F, 1.0F, 1.0F, -1.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition shield = left_arm.addOrReplaceChild("shield",
				CubeListBuilder.create().texOffs(25, 32)
						.addBox(0.0F, -1.1935F, -6.0F, 0.0F, 2.3869F, 12.0F, new CubeDeformation(0.0F)).texOffs(67, 119)
						.addBox(-0.5F, -1.1935F, -6.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(21, 118)
						.addBox(-0.5F, -1.1935F, 5.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(105, 109)
						.addBox(0.0F, -6.0F, -1.1935F, 0.0F, 12.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(116, 74)
						.addBox(-0.5F, 5.0F, -1.1935F, 1.0F, 1.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(97, 78)
		...
		PartDefinition shield_r1 = shield.addOrReplaceChild("shield_r1",
				CubeListBuilder.create().texOffs(115, 114)
						.addBox(7.0F, -6.0F, -1.1935F, 1.0F, 1.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(78, 116)
						.addBox(7.0F, 5.0F, -1.1935F, 1.0F, 1.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(110, 109)
						.addBox(7.5F, -6.0F, -1.1935F, 0.0F, 12.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(26, 118)
						.addBox(7.0F, -1.1935F, 5.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(72, 119)
		...
		PartDefinition shield_r2 = shield.addOrReplaceChild("shield_r2",
				CubeListBuilder.create().texOffs(92, 116).addBox(-0.5F, -1.0F, -1.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition shield_r3 = shield.addOrReplaceChild("shield_r3",
				CubeListBuilder.create().texOffs(116, 70)
						.addBox(7.0F, 5.0F, -1.1935F, 1.0F, 1.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(85, 116)
						.addBox(7.0F, -6.0F, -1.1935F, 1.0F, 1.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(100, 109)
						.addBox(7.5F, -6.0F, -1.1935F, 0.0F, 12.0F, 2.3869F, new CubeDeformation(0.0F)).texOffs(118, 16)
						.addBox(7.0F, -1.1935F, 5.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(115, 118)
						.addBox(7.0F, -1.1935F, -6.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(7.5F, -1.1935F, -6.0F, 0.0F, 2.3869F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.5F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition shield_r4 = shield.addOrReplaceChild("shield_r4",
				CubeListBuilder.create().texOffs(31, 118)
						.addBox(7.0F, -1.1935F, 5.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(119, 88)
						.addBox(7.0F, -1.1935F, -6.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
						.addBox(7.5F, -1.1935F, -6.0F, 0.0F, 2.3869F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.5F, 0.0F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition shield_r5 = shield.addOrReplaceChild("shield_r5",
				CubeListBuilder.create().texOffs(44, 114)
						.addBox(7.0F, -1.1935F, 5.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 118)
						.addBox(7.0F, -1.1935F, -6.0F, 1.0F, 2.3869F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 17)
						.addBox(7.5F, -1.1935F, -6.0F, 0.0F, 2.3869F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.5F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
