...
public class ModelEnemySoldier<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition event = head.addOrReplaceChild("event", CubeListBuilder.create().texOffs(104, 112)
				.addBox(-0.1667F, -0.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
				.addBox(-0.1667F, -2.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
				.addBox(-0.8333F, -2.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
				.addBox(-0.8333F, -0.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
				.addBox(-0.8333F, -4.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
				.addBox(-0.1667F, -4.1667F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
				.addBox(-0.8333F, 2.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 112)
