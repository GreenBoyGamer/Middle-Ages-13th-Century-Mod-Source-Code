...
public class ModelMadievalHorseCartss<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "madievalhorsecartss"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Waist.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(137, 282)
						...
						.addBox(-0.65F, -8.2969F, 3.1F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(213, 316)
		...
		PartDefinition mouth3 = Head.addOrReplaceChild("mouth3", CubeListBuilder.create().texOffs(189, 308)
