...
public class ModelMadievalHorse<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "madievalhorse"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeadL = leads.addOrReplaceChild("LeadL", CubeListBuilder.create(),
				PartPose.offsetAndRotation(5.3333F, 0.0F, 0.0F, -0.22F, -0.1278F, 0.0285F));
		...
		PartDefinition LeadR = leads.addOrReplaceChild("LeadR", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3054F, 0.3054F, 0.0F));
		...
		PartDefinition body_r2 = body2.addOrReplaceChild("body_r2",
		...
		PartDefinition body_r6 = body2.addOrReplaceChild("body_r6",
		...
		PartDefinition tail_r9 = tail.addOrReplaceChild("tail_r9",
				CubeListBuilder.create().texOffs(243, 137).addBox(-1.5F, -4.8833F, -1.6781F, 3.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
